...
!function(e, t) {
    ...
    w.fn.extend({
        ...
        w.fn[e] = function(n, r) {
            ...
            1 < this.length && (O[e] || w.uniqueSort(i), H.test(e) && i.reverse()), this.pushStack(i);
        };
    });
    var M = /[^\x20\t\r\n\f]+/g;
    function I(e) {
                        ...
                        return function() {
                            var s = this, u = arguments, l = function() {
                                ...
                                try {
                                    ...
                                    w.Deferred.exceptionHook && w.Deferred.exceptionHook(e, c.stackTrace), o <= t + 1 && (r !== W && (s = void 0, 
    ...
    function xe(e, t, n, r, i) {
        ...
        for (f.textContent = "", d = 0; o = p[d++]; ) if (r && -1 < w.inArray(o, r)) i && i.push(o); else if (l = w.contains(o.ownerDocument, o), 
    ...
    w.event = {
        ...
        handlers: function(e, t) {
            ...
            if (u && l.nodeType && !("click" === e.type && 1 <= e.button)) for (;l !== this; l = l.parentNode || this) if (1 === l.nodeType && ("click" !== e.type || !0 !== l.disabled)) {
                for (o = [], a = {}, n = 0; n < u; n++) void 0 === a[i = (r = t[n]).selector + " "] && (a[i] = r.needsContext ? -1 < w(i, this).index(l) : w.find(i, this, null, [ l ]).length), 
                a[i] && o.push(r);
                o.length && s.push({
                    elem: l,
                    handlers: o
    ...
    w.extend(w.event, {
        trigger: function(t, n, i, o) {
            ...
            if (s = h = u = i = i || r, 3 !== i.nodeType && 8 !== i.nodeType && !wt.test(m + w.event.triggered) && (-1 < m.indexOf(".") && (m = (x = m.split(".")).shift(), 
            ...
            d = w.event.special[m] || {}, o || !d.trigger || !1 !== d.trigger.apply(i, n))) {
                ...
                for (a = 0; (s = v[a++]) && !t.isPropagationStopped(); ) h = s, t.type = 1 < a ? l : d.bindType || m, 
    ...
    Bt.href = Ct.href, w.extend({
        ...
        ajax: function(t, n) {
            ...
            function k(t, n, r, s) {
                var l, p, d, b, T, C = n;
                c || (c = !0, u && e.clearTimeout(u), i = void 0, a = s || "", E.readyState = 0 < t ? 4 : 0, 
                l = 200 <= t && t < 300 || 304 === t, r && (b = function(e, t, n) {
    ...
    w.ajaxSetup({
        ...
        return -1 < s && (r = vt(e.slice(s)), e = e.slice(0, s)), g(t) ? (n = t, t = void 0) : t && "object" == typeof t && (i = "POST"), 
        0 < a.length && w.ajax({
            url: e,
            type: i || "GET",
            dataType: "html",
        ...
        setOffset: function(e, t, n) {
            ...
            u = w.css(e, "left"), ("absolute" === c || "fixed" === c) && -1 < (o + u).indexOf("auto") ? (a = (r = f.position()).top, 
    ...
    function t(t, s) {
        ...
        return "area" === r ? (a = (n = t.parentNode).name, !(!t.href || !a || "map" !== n.nodeName.toLowerCase()) && (!!(o = e("img[usemap='#" + a + "']")[0]) && i(o))) : (/^(input|select|textarea|button|object)$/.test(r) ? !t.disabled : "a" === r && t.href || s) && i(t);
    }
    function i(t) {
    ...
    e.cleanData = function(t) {
        ...
        for (var i, s, n = u.call(arguments, 1), a = 0, o = n.length; a < o; a++) for (i in n[a]) s = n[a][i], 
        ...
        e.fn[t] = function(n) {
            ...
            return a ? this.each(function() {
                ...
                return "instance" === n ? (r = a, !1) : a ? e.isFunction(a[n]) && "_" !== n.charAt(0) ? (i = a[n].apply(a, o)) !== a && void 0 !== i ? (r = i && i.jquery ? r.pushStack(i.get()) : i, 
    ...
    e(document).mouseup(function() {
        ...
        e.position = {
            scrollbarWidth: function() {
                ...
                return e("body").append(s), t = a.offsetWidth, s.css("overflow", "scroll"), t === (i = a.offsetWidth) && (i = s[0].clientWidth), 
                s.remove(), n = t - i;
            },
            ...
            }(_), _[0].preventDefault && (n.at = "left top"), m = b.width, g = b.height, v = b.offset, 
            ...
            y.left += p[0], y.top += p[1], this.each(function() {
                ...
                M.left += C[0], M.top += C[1], a || (M.left = h(M.left), M.top = h(M.top)), s = {
                    ...
                    m < d && m > r(t + i) && (h.horizontal = "center"), g < c && g > r(s + a) && (h.vertical = "middle"), 
            ...
            fit: {
                left: function(e, t) {
                    ...
                    t.collisionWidth > a ? 0 < h && l <= 0 ? (i = e.left + h + t.collisionWidth - a - n, 
                    e.left += h - i) : e.left = 0 < l && h <= 0 ? n : l < h ? n + a - t.collisionWidth : n : 0 < h ? e.left += h : 0 < l ? e.left -= l : e.left = o(e.left - r, e.left);
                },
                top: function(e, t) {
                    var i, s = t.within, n = s.isWindow ? s.scrollTop : s.offset.top, a = t.within.height, r = e.top - t.collisionPosition.marginTop, h = n - r, l = r + t.collisionHeight - a - n;
                    t.collisionHeight > a ? 0 < h && l <= 0 ? (i = e.top + h + t.collisionHeight - a - n, 
                    e.top += h - i) : e.top = 0 < l && h <= 0 ? n : l < h ? n + a - t.collisionHeight : n : 0 < h ? e.top += h : 0 < l ? e.top -= l : e.top = o(e.top - r, e.top);
                }
            },
            flip: {
                left: function(e, t) {
                    var i, s, n = t.within, a = n.offset.left + n.scrollLeft, o = n.width, h = n.isWindow ? n.scrollLeft : n.offset.left, l = e.left - t.collisionPosition.marginLeft, u = l - h, d = l + t.collisionWidth - o - h, c = "left" === t.my[0] ? -t.elemWidth : "right" === t.my[0] ? t.elemWidth : 0, p = "left" === t.at[0] ? t.targetWidth : "right" === t.at[0] ? -t.targetWidth : 0, f = -2 * t.offset[0];
                    u < 0 ? ((i = e.left + c + p + f + t.collisionWidth - o - a) < 0 || r(u) > i) && (e.left += c + p + f) : 0 < d && ((0 < (s = e.left - t.collisionPosition.marginLeft + c + p + f - h) || d > r(s)) && (e.left += c + p + f));
                },
                top: function(e, t) {
                    var i, s, n = t.within, a = n.offset.top + n.scrollTop, o = n.height, h = n.isWindow ? n.scrollTop : n.offset.top, l = e.top - t.collisionPosition.marginTop, u = l - h, d = l + t.collisionHeight - o - h, p = "top" === t.my[1] ? -t.elemHeight : "bottom" === t.my[1] ? t.elemHeight : 0, f = "top" === t.at[1] ? t.targetHeight : "bottom" === t.at[1] ? -t.targetHeight : 0, m = -2 * t.offset[1];
                    u < 0 ? ((s = e.top + p + f + m + t.collisionHeight - o - a) < 0 || r(u) > s) && (e.top += p + f + m) : 0 < d && ((0 < (i = e.top - t.collisionPosition.marginTop + p + f + m - h) || d > r(i)) && (e.top += p + f + m));
                }
            },
            flipfit: {
                left: function() {
            ...
            for (o in t = document.createElement(r ? "div" : "body"), s = {
                visibility: "hidden",
                width: 0,
                height: 0,
                border: 0,
            ...
            t.appendChild(h), (i = r || document.documentElement).insertBefore(t, i.firstChild), 
            h.style.cssText = "position: absolute; left: 10.7432222px;", n = e(h).offset().left, 
            a = 10 < n && n < 11, t.innerHTML = "", i.removeChild(t);
        }();
        ...
        refresh: function() {
            var i, s = this, n = this.options.icons.submenu, a = this.element.find(this.options.menus);
            ...
            }), (i = a.add(this.element).find(this.options.items)).not(".ui-menu-item").each(function() {
                var t = e(this);
        ...
        _scrollIntoView: function(t) {
            ...
            n < 0 ? this.activeMenu.scrollTop(a + n) : o < n + r && this.activeMenu.scrollTop(a + n - o + r));
        },
        blur: function(e, t) {
        ...
        _create: function() {
            ...
            this._on(this.element, {
                keydown: function(n) {
                    if (this.element.prop("readOnly")) i = s = t = !0; else {
                        i = s = t = !1;
                        var a = e.ui.keyCode;
                        switch (n.keyCode) {
                          case a.PAGE_UP:
    ...
    var c, v, p = "ui-button ui-widget ui-state-default ui-corner-all", f = "ui-button-icons-only ui-button-icon-only ui-button-text-icons ui-button-text-icon-primary ui-button-text-icon-secondary ui-button-text-only", m = function() {
        var t = e(this);
        setTimeout(function() {
    ...
    e.widget("ui.button", {
        ...
        _attachDatepicker: function(t, i) {
            var s, n, a;
            n = "div" === (s = t.nodeName.toLowerCase()) || "span" === s, t.id || (this.uuid += 1, 
            t.id = "dp" + this.uuid), (a = this._newInst(e(t), n)).settings = e.extend({}, i || {}), 
        ...
        _attachments: function(t, i) {
            ...
            ("focus" === (s = this._get(i, "showOn")) || "both" === s) && t.focus(this._showDatepicker), 
        ...
        _autoSize: function(e) {
            if (this._get(e, "autoSize") && !e.inline) {
                ...
                o.match(/[DM]/) && (t = function(e) {
                    for (n = s = i = 0; e.length > n; n++) e[n].length > i && (i = e[n].length, s = n);
                    return s;
        ...
        _dialogDatepicker: function(t, i, s, n, a) {
            ...
            (c = this._dialogInst = this._newInst(this._dialogInput, !1)).settings = {}, e.data(this._dialogInput[0], "datepicker", c)), 
        ...
        _doKeyDown: function(t) {
            ...
            if (a._keyEvent = !0, e.datepicker._datepickerShowing) switch (t.keyCode) {
              ...
              case 13:
                ...
                (i = e.datepicker._get(a, "onSelect")) ? (s = e.datepicker._formatDate(a), i.apply(a.input ? a.input[0] : null, [ s, a ])) : e.datepicker._hideDatepicker(), 
                !1;
        ...
        _doKeyPress: function(t) {
            ...
            s = String.fromCharCode(null == t.charCode ? t.keyCode : t.charCode), t.ctrlKey || t.metaKey || s < " " || !i || -1 < i.indexOf(s)) : void 0;
        },
        _doKeyUp: function(t) {
        ...
        _showDatepicker: function(t) {
            ...
            !1 !== (a = (n = e.datepicker._get(i, "beforeShow")) ? n.apply(t, [ t, i ]) : {}) && (r(i.settings, a), 
            ...
            i.dpDiv.css("z-index", function(e) {
                ...
                return 0;
            }(e(t)) + 1), e.datepicker._datepickerShowing = !0, e.effects && e.effects.effect[l] ? i.dpDiv.show(l, e.datepicker._get(i, "showOptions"), u) : i.dpDiv[l || "show"](l ? u : null), 
        ...
        _checkOffset: function(t, i, s) {
            ...
            i.top -= Math.min(i.top, i.top + a > l && a < l ? Math.abs(a + r) : 0), i;
        },
        _findPos: function(t) {
        ...
        _hideDatepicker: function(t) {
            ...
            i || n(), this._datepickerShowing = !1, (a = this._get(o, "onClose")) && a.apply(o.input ? o.input[0] : null, [ o.input ? o.input.val() : "", o ]), 
        ...
        _selectDay: function(t, i, s, n) {
            ...
            a.selectedMonth = a.currentMonth = i, a.selectedYear = a.currentYear = s, this._selectDate(t, this._formatDate(a, a.currentDay, a.currentMonth, a.currentYear)));
        },
        ...
        parseDate: function(t, i, s) {
            ...
            var n, a, o, r, h = 0, l = (s ? s.shortYearCutoff : null) || this._defaults.shortYearCutoff, u = "string" != typeof l ? l : new Date().getFullYear() % 100 + parseInt(l, 10), d = (s ? s.dayNamesShort : null) || this._defaults.dayNamesShort, c = (s ? s.dayNames : null) || this._defaults.dayNames, p = (s ? s.monthNamesShort : null) || this._defaults.monthNamesShort, f = (s ? s.monthNames : null) || this._defaults.monthNames, m = -1, g = -1, v = -1, y = -1, b = !1, _ = function(e) {
                ...
                var t = _(e), s = "@" === e ? 14 : "!" === e ? 20 : "y" === e && t ? 4 : "o" === e ? 3 : 2, a = RegExp("^\\d{" + ("y" === e ? s : 1) + "," + s + "}"), o = i.substring(h).match(a);
            ...
            -1 < y) for (g = 1, v = y; !(v <= (a = this._getDaysInMonth(m, g - 1))); ) g++, 
            v -= a;
        ...
        formatDate: function(e, t, i) {
            ...
            if (t) for (s = 0; e.length > s; s++) if (c) "'" !== e.charAt(s) || h("'") ? d += e.charAt(s) : c = !1; else switch (e.charAt(s)) {
              ...
              case "y":
                d += h("y") ? t.getFullYear() : (t.getYear() % 100 < 10 ? "0" : "") + t.getYear() % 100;
                break;
        ...
        _determineDate: function(t, i, s) {
            ...
            return (o = o && "Invalid Date" == "" + o ? s : o) && (o.setHours(0), o.setMinutes(0), 
        ...
        _generateHTML: function(e) {
            ...
            if (Z < 0 && (Z += 12, et--), $) for (t = this._daylightSavingAdjust(new Date($.getFullYear(), $.getMonth() - K[0] * K[1] + 1, $.getDate())), 
            t = X && t < X ? X : t; this._daylightSavingAdjust(new Date(et, Z, 1)) > t; ) --Z < 0 && (Z = 11, 
            et--);
            ...
            y = this._get(e, "selectOtherMonths"), b = this._getDefaultDate(e), _ = "", w = 0; K[0] > w; w++) {
                for (k = "", this.maxRows = 4, T = 0; K[1] > T; T++) {
                    ...
                    M = "", Q) {
                        if (M += "<div class='ui-datepicker-group", 1 < K[1]) switch (T) {
                          case 0:
                    ...
                    for (M += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + S + "'>" + (/all|left/.test(S) && 0 === w ? Y ? a : s : "") + (/all|right/.test(S) && 0 === w ? Y ? s : a : "") + this._generateMonthYearHeader(e, Z, et, X, $, 0 < w || 0 < T, f, m) + "</div><table class='ui-datepicker-calendar'><thead><tr>", 
                    C = d ? "<th class='ui-datepicker-week-col'>" + this._get(e, "weekHeader") + "</th>" : "", 
                    x = 0; x < 7; x++) C += "<th scope='col'" + (5 <= (x + u + 6) % 7 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + c[N = (x + u) % 7] + "'>" + p[N] + "</span></th>";
        ...
        _generateMonthYearHeader: function(e, t, i, s, n, a, o, r) {
            ...
            if (a || !g) _ += "<span class='ui-datepicker-month'>" + o[t] + "</span>"; else {
                ...
                u = 0; u < 12; u++) (!h || u >= s.getMonth()) && (!l || n.getMonth() >= u) && (_ += "<option value='" + u + "'" + (u === t ? " selected='selected'" : "") + ">" + r[u] + "</option>");
                _ += "</select>";
            }
            if (y || (b += _ + (!a && g && v ? "" : "&#xa0;")), !e.yearshtml) if (e.yearshtml = "", 
            a || !v) b += "<span class='ui-datepicker-year'>" + i + "</span>"; else {
                for (d = this._get(e, "yearRange").split(":"), c = new Date().getFullYear(), f = (p = function(e) {
                    var t = e.match(/c[+\-].*/) ? i + parseInt(e.substring(1), 10) : e.match(/[+\-].*/) ? c + parseInt(e, 10) : parseInt(e, 10);
                    return isNaN(t) ? c : t;
                })(d[0]), m = Math.max(f, p(d[1] || "")), f = s ? Math.max(f, s.getFullYear()) : f, 
                m = n ? Math.min(m, n.getFullYear()) : m, e.yearshtml += "<select class='ui-datepicker-year' data-handler='selectYear' data-event='change'>"; f <= m; f++) e.yearshtml += "<option value='" + f + "'" + (f === i ? " selected='selected'" : "") + ">" + f + "</option>";
        ...
        _canAdjustMonth: function(e, t, i, s) {
            var n = this._getNumberOfMonths(e), a = this._daylightSavingAdjust(new Date(i, s + (t < 0 ? t : n[0] * n[1]), 1));
    ...
    e.datepicker.version = "1.11.4", e.datepicker, e.widget("ui.draggable", e.ui.mouse, {
        ...
        drag: function(t, i, s) {
            ...
            for (c = s.snapElements.length - 1; 0 <= c; c--) l = (h = s.snapElements[c].left - s.margins.left) + s.snapElements[c].width, 
        ...
        _setOption: function(e, t) {
            ...
            "closeText" === e && this.uiDialogTitlebarClose.button({
                label: "" + t
            }), "draggable" === e && ((i = n.is(":data(ui-draggable)")) && !t && n.draggable("destroy"), 
            !i && t && this._makeDraggable()), "position" === e && this._position(), "resizable" === e && ((s = n.is(":data(ui-resizable)")) && !t && n.resizable("destroy"), 
            s && "string" == typeof t && n.resizable("option", "handles", t), s || !1 === t || this._makeResizable()), 
    ...
    e.effects = {
        ...
        p.style.cssText = "background-color:rgba(1,1,1,.5)", c.rgba = -1 < p.style.backgroundColor.indexOf("rgba"), 
        f(u, function(e, t) {
            ...
            parse: function(n, o, r, h) {
                ...
                return o !== t && (n = [ n, o, r, h ], c = "array"), "string" === c ? this.parse(s(n) || a._default) : "array" === c ? (f(u.rgba.props, function(e, t) {
                    p[t.idx] = i(n[t.idx], t);
                }), this) : "object" === c ? (f(u, n instanceof l ? function(e, t) {
                    ...
                    f(s.props, function(e, t) {
                        ...
                        d[a][t.idx] = i(n[e], t, !0);
                    }), d[a] && e.inArray(null, d[a].slice(0, 3)) < 0 && (d[a][3] = 1, s.from && (d._rgba = s.from(d[a])));
                }), this) : t;
            },
            is: function(e) {
            ...
            i = 0 === l ? 0 : d <= .5 ? l / u : l / (2 - u), [ Math.round(t) % 360, i, d, null == o ? 1 : o ];
        }, u.hsla.from = function(e) {
            if (null == e[0] || null == e[1] || null == e[2]) return [ null, null, null, e[3] ];
            var t = e[0] / 360, i = e[1], s = e[2], a = e[3], o = s <= .5 ? s * (1 + i) : s + i - s * i, r = 2 * s - o;
        ...
        function t(t) {
            ...
            if (n && n.length && n[0] && n[n[0]]) for (s = n.length; s--; ) "string" == typeof n[i = n[s]] && (a[e.camelCase(i)] = n[i]); else for (i in n) "string" == typeof n[i] && (a[i] = n[i]);
            return a;
        }
        function i(t, i) {
            var s, a, o = {};
        ...
        e.extend(e.effects, {
            ...
            restore: function(e, t) {
                var i, s;
                for (s = 0; t.length > s; s++) null !== t[s] && (void 0 === (i = e.data(y + t[s])) && (i = ""), 
                e.css(t[s], i));
            },
        ...
        var s, n, a, o = e(this), l = [ "position", "top", "bottom", "left", "right", "height", "width" ], u = e.effects.setMode(o, t.mode || "hide"), d = t.direction || "up", c = /up|down|vertical/.test(d), p = c ? "height" : "width", f = c ? "top" : "left", m = /up|left|vertical|horizontal/.test(d), g = {}, v = "show" === u;
        ...
        c || (c = o["top" === v ? "outerHeight" : "outerWidth"]() / 3), u && ((a = {
            opacity: 1
        })[v] = 0, o.css("opacity", 0).css(v, y ? 2 * -c : 2 * c).animate(a, m, g)), l && (c /= Math.pow(2, p - 1)), 
        s = (a = {})[v] = 0; s < p; s++) (n = {})[v] = (y ? "-=" : "+=") + c, o.animate(n, m, g).animate(a, m, g), 
        c = l ? 2 * c : c / 2;
        l && ((n = {
            opacity: 0
        })[v] = (y ? "-=" : "+=") + c, o.animate(n, m, g)), o.queue(function() {
            l && o.hide(), e.effects.restore(o, r), e.effects.removeWrapper(o), i();
        }), 1 < _ && b.splice.apply(b, [ 1, 0 ].concat(b.splice(_, f + 1))), o.dequeue();
        ...
        function s() {
            b.push(this), b.length === d * c && (p.css({
                visibility: "visible"
        ...
        for (a = 0; a < d; a++) for (h = g.top + a * y, u = a - (d - 1) / 2, o = 0; o < c; o++) r = g.left + o * v, 
        ...
        var s, n, a, o = e(this), r = [ "position", "top", "bottom", "left", "right", "width", "height", "overflow", "opacity" ], l = [ "width", "height", "overflow" ], u = [ "fontSize" ], d = [ "borderTopWidth", "borderBottomWidth", "paddingTop", "paddingBottom" ], c = [ "borderLeftWidth", "borderRightWidth", "paddingLeft", "paddingRight" ], p = e.effects.setMode(o, t.mode || "effect"), f = t.restore || "effect" !== p, m = t.scale || "both", g = t.origin || [ "middle", "center" ], v = o.css("position"), y = f ? r : [ "position", "top", "bottom", "left", "right", "overflow", "opacity" ], b = {
            height: 0,
            width: 0,
            outerHeight: 0,
            outerWidth: 0
        ...
        c = c.concat([ "marginLeft", "marginRight" ]), l = r.concat(d).concat(c), o.find("*[width]").each(function() {
            var i = e(this), s_height = i.height(), s_width = i.width(), s_outerHeight = i.outerHeight(), s_outerWidth = i.outerWidth();
            f && e.effects.save(i, l), i.from = {
                height: s_height * a.from.y,
                width: s_width * a.from.x,
                outerHeight: s_outerHeight * a.from.y,
                outerWidth: s_outerWidth * a.from.x
            }, i.to = {
                height: s_height * a.to.y,
                width: s_width * a.to.x,
                outerHeight: s_height * a.to.y,
                outerWidth: s_width * a.to.x
        ...
        }, u_y = "horizontal" !== r ? o / 100 : 1, u_x = "vertical" !== r ? o / 100 : 1;
        ...
        n.restore = !0), n.from = t.from || ("show" === a ? {
            ...
            height: l.height * u_y,
            width: l.width * u_x,
            outerHeight: l.outerHeight * u_y,
            outerWidth: l.outerWidth * u_x
        ...
        for ((o || !n.is(":visible")) && (n.css("opacity", 0).show(), d = 1), s = 1; s < l; s++) n.animate({
            opacity: d
        }, u, t.easing), d = 1 - d;
        n.animate({
            opacity: d
            ...
            r && n.hide(), i();
        }), 1 < p && c.splice.apply(c, [ 1, 0 ].concat(c.splice(p, l + 1))), n.dequeue();
        ...
        s = 1; s < l; s++) n.animate(m, d, t.easing).animate(g, d, t.easing);
        n.animate(m, d, t.easing).animate(f, d / 2, t.easing).queue(function() {
            "hide" === o && n.hide(), e.effects.restore(n, a), e.effects.removeWrapper(n), i();
        }), 1 < y && v.splice.apply(v, [ 1, 0 ].concat(v.splice(y, u + 1))), n.dequeue();
        ...
        _move: function(e, t) {
            ...
            n += ":not(.ui-state-disabled)"), (s = "first" === e || "last" === e ? i["first" === e ? "prevAll" : "nextAll"](n).eq(-1) : i[e + "All"](n).eq(0)).length && this.menuInstance.focus(t, s);
        },
        ...
        _createHandles: function() {
            ...
            n = n.slice(0, i)), t = n.length; t < i; t++) o.push("<span class='ui-slider-handle ui-state-default ui-corner-all' tabindex='0'></span>");
        ...
        _mouseCapture: function(t) {
            ...
            this.handles.each(function(t) {
                ...
                (i < n || n === i && (t === u._lastChangedValue || u.values(t) === d.min)) && (n = i, 
                a = e(this), o = t);
        ...
        _normValueFromMouse: function(e) {
            ...
            1 < (s = i / t) && (s = 1), s < 0 && (s = 0), "vertical" === this.orientation && (s = 1 - s), 
        ...
        _slide: function(e, t, i) {
            ...
            i !== this.values(t) && ((n = this.values())[t] = i, a = this._trigger("slide", e, {
                handle: this.handles[t],
                value: i,
                values: n
        ...
        values: function(t, i) {
            ...
            for (s = this.options.values, n = t, a = 0; s.length > a; a += 1) s[a] = this._trimAlignValue(n[a]), 
            this._change(null, a);
            this._refreshValue();
        },
        _setOption: function(t, i) {
        ...
        _intersectsWith: function(e) {
            var t = this.positionAbs.left, i = t + this.helperProportions.width, s = this.positionAbs.top, n = s + this.helperProportions.height, a = e.left, o = a + e.width, r = e.top, h = r + e.height, l = this.offset.click.top, u = this.offset.click.left, d = "x" === this.options.axis || r < s + l && s + l < h, c = "y" === this.options.axis || a < t + u && t + u < o, p = d && c;
        ...
        _refreshItems: function(t) {
            ...
            for (i = d.length - 1; 0 <= i; i--) for (o = d[i][1], s = 0, l = (r = d[i][0]).length; s < l; s++) (h = e(r[s])).data(this.widgetName + "-item", o), 
            u.push({
                item: h,
                instance: o,
                width: 0,
        ...
        _contactContainers: function(t) {
            ...
            for (i = this.containers.length - 1; 0 <= i; i--) if (!e.contains(this.currentItem[0], this.containers[i].element[0])) if (this._intersectsWith(this.containers[i].containerCache)) {
        ...
        _adjustValue: function(e) {
            ...
            return i = e - (t = null !== s.min ? s.min : 0), e = t + (i = Math.round(i / s.step) * s.step), 
            e = parseFloat(e.toFixed(this._precision())), null !== s.max && e > s.max ? s.max : null !== s.min && s.min > e ? s.min : e;
        },
        _stop: function(e) {
        ...
        _isLocal: function() {
            ...
            return function(t) {
                var i, s;
                i = (t = t.cloneNode(!1)).href.replace(e, ""), s = location.href.replace(e, "");
                try {
        ...
        _findNextTab: function(t, i) {
            for (var n = this.tabs.length - 1; -1 !== e.inArray((n < t && (t = 0), t < 0 && (t = n), 
        ...
        _processTabs: function() {
            ...
            this.tablist = this._getList().addClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all").attr("role", "tablist").delegate("> li", "mousedown" + this.eventNamespace, function(t) {
                ...
                t._isLocal(s) ? (o = (n = s.hash).substring(1), a = t.element.find(t._sanitizeSelector(n))) : (n = "#" + (o = h.attr("aria-controls") || e({}).uniqueId()[0].id), 
                (a = t.element.find(n)).length || (a = t._createPanel(o)).insertAfter(t.panels[i - 1] || t.tablist), 
        ...
        _eventHandler: function(t) {
            var i = this.options, s = this.active, a = e(t.currentTarget).closest("li"), o = a[0] === s[0], r = o && i.collapsible, h = r ? e() : this._getPanelForTab(a), l = s.length ? this._getPanelForTab(s) : e(), u = {
                oldTab: s,
                oldPanel: l,
                newTab: r ? e() : a,
                newPanel: h
        ...
        _removeDescribedBy: function(t) {
            ...
            -1 !== n && s.splice(n, 1), t.removeData("ui-tooltip-id"), (s = e.trim(s.join(" "))) ? t.attr("aria-describedby", s) : t.removeAttr("aria-describedby");
        },
        _create: function() {
            this._on({
                mouseover: "open",
        ...
        _open: function(t, i, s) {
            ...
            if (s) {
                ...
                this.liveRegion.children().hide(), s.clone ? (h = s.clone()).removeAttr("id").find("[id]").removeAttr("id") : h = s, 
    ...
    for (var r, n, o, a, l, f, p, g, m, _, v, E, y, b, w, S, O, N, k, L, P, x, j, R, M, H, W, F, K, Q, J, Z, $, tt, et, nt, it, rt, ot, st, at, lt, ct, ft, dt, pt, gt = function(i) {
        var e = "transitionend";
        var l = {
    ...
    b = "active", "btn", w = '[data-toggle^="button"]', '[data-toggle="buttons"]', "input", 
    ".active", S = ".btn", O = {
        ...
        t.preventDefault();
        var e = t.target;
        g(e).hasClass("btn") || (e = g(e).closest(S)), N._jQueryInterface.call(g(e), "toggle");
    }).on(O.FOCUS_BLUR_DATA_API, w, function(t) {
        var e = g(t.target).closest(S)[0];
        g(e).toggleClass("focus", /^focus(in)?$/.test(t.type));
    }), g.fn[m] = N._jQueryInterface, g.fn[m].Constructor = N, g.fn[m].noConflict = function() {
        return g.fn[m] = y, N._jQueryInterface;
    }, N), vt = (L = "carousel", x = "." + (P = "bs.carousel"), j = ".data-api", R = (k = e).fn[L], 
    M = {
        interval: 5e3,
        keyboard: !0,
        slide: !1,
    ...
    }, "carousel", Q = "active", "slide", "carousel-item-right", "carousel-item-left", 
    "carousel-item-next", "carousel-item-prev", J = {
        ACTIVE: ".active",
        ...
        return t.next = function() {
            ...
            if (t === W ? (n = "carousel-item-left", i = "carousel-item-next", r = "left") : (n = "carousel-item-right", 
            i = "carousel-item-prev", r = "right"), l && k(l).hasClass(Q)) this._isSliding = !1; else if (!this._triggerSlideEvent(l, r).isDefaultPrevented() && s && l) {
    ...
    }, at = "show", lt = "collapse", ct = "collapsing", ft = "collapsed", "width", "height", 
    dt = {
        ...
        return t.toggle = function() {
            ...
            if (!this._isTransitioning && $(this._element).hasClass(at)) {
                ...
                if ($(this._element).trigger(e), !e.isDefaultPrevented()) {
                    ...
                    $(this._element).addClass(ct).removeClass(lt).removeClass(at), 0 < this._triggerArray.length) for (var i = 0; i < this._triggerArray.length; i++) {
                        ...
                        null !== o && ($(o).hasClass(at) || $(r).addClass(ft).attr("aria-expanded", !1));
                    }
            ...
            return $(this._element).hasClass("width") ? "width" : "height";
        }, t._getParent = function() {
            var n = this, t = null;
            gt.isElement(this._config.parent) ? (t = this._config.parent, void 0 !== this._config.parent.jquery && (t = this._config.parent[0])) : t = $(this._config.parent)[0];
    ...
    function Kt(t) {
        ...
        }, o = "HTML" === t.nodeName ? Mt() : {}, s = o.width || t.clientWidth || r.right - r.left, a = o.height || t.clientHeight || r.bottom - r.top, l = t.offsetWidth - s, c = t.offsetHeight - a;
        if (l || c) {
            var f = Dt(t);
    ...
    function Vt(t, e) {
        var n = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], i = Nt(10), r = "HTML" === e.nodeName, o = Kt(t), s = Kt(e), a = St(t), l = Dt(e), c = parseFloat(l.borderTopWidth, 10), f = parseFloat(l.borderLeftWidth, 10);
        ...
        return (i && !n ? e.contains(a) : e === a && "BODY" !== a.nodeName) && (h = function(t, e) {
            var n = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], i = xt(e, "top"), r = xt(e, "left"), o = n ? -1 : 1;
    ...
    function Yt(t, e, n, i) {
        ...
        if ("viewport" === i) o = function(t) {
            var e = 1 < arguments.length && void 0 !== arguments[1] && arguments[1], n = t.ownerDocument.documentElement, i = Vt(t, n), r = Math.max(n.clientWidth, window.innerWidth || 0), o = Math.max(n.clientHeight, window.innerHeight || 0), s = e ? 0 : xt(n), a = e ? 0 : xt(n, "left");
            return Bt({
    ...
    function Jt(t, e, n) {
        ...
        return r[s] = e[s] + e[l] / 2 - i[l] / 2, r[a] = n === a ? e[a] - i[c] : e[Xt(a)], 
        r;
    }
    function Zt(t, e) {
    ...
    function $t(t, n, e) {
        return (void 0 === e ? t : t.slice(0, function(t, e, n) {
            ...
            t.enabled && It(e) && (n.offsets.popper = Bt(n.offsets.popper), n.offsets.reference = Bt(n.offsets.reference), 
            n = e(n, t));
        }), n;
    }
    function te(t, n) {
    ...
    var le = [ "auto-start", "auto", "auto-end", "top-start", "top", "top-end", "right-start", "right", "right-end", "bottom-end", "bottom", "bottom-start", "left-end", "left", "left-start" ], ce = le.slice(3);
    function fe(t) {
        var e = 1 < arguments.length && void 0 !== arguments[1] && arguments[1], n = ce.indexOf(t), i = ce.slice(n + 1).concat(ce.slice(0, n));
        return e ? i.reverse() : i;
    }
    var he_FLIP = "flip", he_CLOCKWISE = "clockwise", he_COUNTERCLOCKWISE = "counterclockwise";
    var de = {
        placement: "bottom",
        positionFixed: !1,
        eventsEnabled: !0,
        ...
        modifiers: {
            ...
            offset: {
                ...
                enabled: !0,
                fn: function(t, e) {
                    var l, n = e.offset, i = t.placement, r = t.offsets, o = r.popper, s = r.reference, a = i.split("-")[0];
                    return l = oe(+n) ? [ +n, 0 ] : function(t, r, o, e) {
                    ...
                    }(n, o, s, a), "left" === a ? (o.top += l[0], o.left -= l[1]) : "right" === a ? (o.top += l[0], 
            ...
            arrow: {
                ...
                fn: function(t, e) {
                    ...
                    t;
                    var r = t.placement.split("-")[0], o = t.offsets, s = o.popper, a = o.reference, l = -1 !== [ "left", "right" ].indexOf(r), c = l ? "height" : "width", f = l ? "Top" : "Left", h = f.toLowerCase(), u = l ? "left" : "top", d = l ? "bottom" : "right", p = zt(i)[c];
                    ...
                    return E = Math.max(Math.min(s[c] - p, E), 0), t.arrowElement = i, t.offsets.arrow = (Ft(n = {}, h, Math.round(E)), 
                    Ft(n, u, ""), n), t;
                },
                element: "[x-arrow]"
            },
            flip: {
                ...
                fn: function(p, g) {
                    ...
                    var m = Yt(p.instance.popper, p.instance.reference, g.padding, g.boundariesElement, p.positionFixed), _ = p.placement.split("-")[0], v = Xt(_), E = p.placement.split("-")[1] || "", y = [];
                    switch (g.behavior) {
                      case he_FLIP:
                        y = [ _, v ];
                        break;
                    ...
                    return y.forEach(function(t, e) {
                        ...
                        p.placement = _ + (E ? "-" + E : ""), p.offsets.popper = Ut({}, p.offsets.popper, Jt(p.instance.popper, p.offsets.reference, p.placement)), 
            ...
            inner: {
                ...
                fn: function(t) {
                    ...
                    return r[s ? "left" : "top"] = o[n] - (a ? r[s ? "width" : "height"] : 0), t.placement = Xt(e), 
                    t.offsets.popper = Bt(r), t;
                }
            },
            hide: {
                order: 800,
            ...
            computeStyle: {
                ...
                fn: function(t, e) {
                    ...
                    var d, p, s = void 0 !== o ? o : e.gpuAcceleration, a = Kt(kt(t.instance.popper)), l = {
                        position: r.position
                    }, c = {
                    ...
                    return t.attributes = Ut({}, _, t.attributes), t.styles = Ut({}, l, t.styles), t.arrowStyles = Ut({}, t.offsets.arrow, t.arrowStyles), 
                    t;
                },
                gpuAcceleration: !0,
                x: "bottom",
            ...
            applyStyle: {
                ...
                fn: function(t) {
                    var e, n;
                    return se(t.instance.popper, t.styles), e = t.instance.popper, n = t.attributes, 
                ...
                onLoad: function(t, e, n, i, r) {
                    var o = qt(r, e, t, n.positionFixed), s = Gt(n.placement, o, e, t, n.modifiers.flip.boundariesElement, n.modifiers.flip.padding);
        ...
        function o(t, e) {
            ...
            }, this.update = wt(this.update.bind(this)), this.options = Ut({}, o.Defaults, i), 
            this.state = {
                isDestroyed: !1,
                isCreated: !1,
                scrollParents: []
            }, this.reference = t && t.jquery ? t[0] : t, this.popper = e && e.jquery ? e[0] : e, 
            this.options.modifiers = {}, Object.keys(Ut({}, o.Defaults.modifiers, i.modifiers)).forEach(function(t) {
        ...
        return Wt(o, [ {
            ...
            value: function() {
                return function() {
                    if (!this.state.isDestroyed) {
                        ...
                        t.offsets.popper = Jt(this.popper, t.offsets.reference, t.placement), t.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", 
                        t = $t(this.modifiers, t), this.state.isCreated ? this.options.onUpdate(t) : (this.state.isCreated = !0, 
            ...
            value: function() {
                return function() {
                    ...
                    this.popper.style[ee("transform")] = ""), this.disableEventListeners(), this.options.removeOnDestroy && this.popper.parentNode.removeChild(this.popper), 
                    this;
                }.call(this);
            }
        }, {
            ...
            value: function() {
                return function() {
                    ...
                    e = this.state, ne(t).removeEventListener("resize", e.updateBound), e.scrollParents.forEach(function(t) {
    ...
    pe.Utils = ("undefined" != typeof window ? window : global).PopperUtils, pe.placements = le, 
    pe.Defaults = de;
    var ge, me, _e, ve, Ee, ye, be, Te, Ce, we, Se, Ne, Le, Ue, Be, Ke, Ve, Qe, Ye, Ge, qe, ze, Xe, Je, tn, en, nn, rn, on, sn, an, ln, cn, fn, hn, un, dn, pn, gn, mn, vn, En, yn, Cn, wn, An, Sn, On, Nn, kn, Ln, Pn, xn, jn, Rn, Un, Bn, Kn, Vn, Qn, Yn, Gn, qn, zn, Xn, Zn, $n, ei, ni, ii, ri, oi, si, ai, ci, gi, mi, yi, bi = (me = "dropdown", 
    ve = "." + (_e = "bs.dropdown"), Ee = ".data-api", ye = (ge = e).fn[me], be = new RegExp("38|40|27"), 
    Te = {
        HIDE: "hide" + ve,
        HIDDEN: "hidden" + ve,
        SHOW: "show" + ve,
    ...
    }, Ce = "disabled", we = "show", "dropup", "dropright", "dropleft", Se = "dropdown-menu-right", 
    "position-static", Ne = '[data-toggle="dropdown"]', ".dropdown form", Le = ".dropdown-menu", 
    ".navbar-nav", ".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", "top-start", 
    "top-end", "bottom-start", "bottom-end", "right-start", "left-start", Ue = {
        offset: 0,
        flip: !0,
        ...
        return t.toggle = function() {
            if (!this._element.disabled && !ge(this._element).hasClass(Ce)) {
                ...
                if (l._clearMenus(), !e) {
                    ...
                    if (ge(t).trigger(i), !i.isDefaultPrevented()) {
                        if (!this._inNavbar) {
                            if (void 0 === pe) throw new TypeError("Bootstrap dropdown require Popper.js (https://popper.js.org)");
                            var r = this._element;
                            "parent" === this._config.reference ? r = t : gt.isElement(this._config.reference) && (r = this._config.reference, 
                            void 0 !== this._config.reference.jquery && (r = this._config.reference[0])), "scrollParent" !== this._config.boundary && ge(t).addClass("position-static"), 
                            this._popper = new pe(r, this._menu, this._getPopperConfig());
                        }
                        "ontouchstart" in document.documentElement && 0 === ge(t).closest(".navbar-nav").length && ge(document.body).children().on("mouseover", null, ge.noop), 
                        this._element.focus(), this._element.setAttribute("aria-expanded", !0), ge(this._menu).toggleClass(we), 
                        ge(t).toggleClass(we).trigger(ge.Event(Te.SHOWN, n));
                    }
                }
            }
        }, t.dispose = function() {
            ge.removeData(this._element, _e), ge(this._element).off(ve), this._element = null, 
            ...
            return t = c({}, this.constructor.Default, ge(this._element).data(), t), gt.typeCheckConfig(me, t, this.constructor.DefaultType), 
            t;
            ...
            var t = ge(this._element).parent(), e = "bottom-start";
            return t.hasClass("dropup") ? (e = "top-start", ge(this._menu).hasClass(Se) && (e = "top-end")) : t.hasClass("dropright") ? e = "right-start" : t.hasClass("dropleft") ? e = "left-start" : ge(this._menu).hasClass(Se) && (e = "bottom-end"), 
            e;
            ...
            return this.each(function() {
                ...
                if (t || (t = new l(this, "object" == typeof e ? e : null), ge(this).data(_e, t)), 
                "string" == typeof e) {
            ...
            if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which)) for (var e = ge.makeArray(ge(Ne)), n = 0; n < e.length; n++) {
                var i = l._getParentFromElement(e[n]), r = ge(e[n]).data(_e), o = {
                    relatedTarget: e[n]
                };
                if (r) {
                    var s = r._menu;
                    if (ge(i).hasClass(we) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && ge.contains(i, t.target))) {
                        ...
                        ge(i).trigger(a), a.isDefaultPrevented() || ("ontouchstart" in document.documentElement && ge(document.body).children().off("mouseover", null, ge.noop), 
                        e[n].setAttribute("aria-expanded", "false"), ge(s).removeClass(we), ge(i).removeClass(we).trigger(ge.Event(Te.HIDDEN, o)));
                    }
                }
            }
            ...
            t.stopPropagation(), !this.disabled && !ge(this).hasClass(Ce))) {
                var e = l._getParentFromElement(this), n = ge(e).hasClass(we);
                if ((n || 27 === t.which && 32 === t.which) && (!n || 27 !== t.which && 32 !== t.which)) {
                    var i = ge(e).find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)").get();
                    if (0 !== i.length) {
    ...
    }, Ke), Ti = (Qe = "modal", Ge = "." + (Ye = "bs.modal"), qe = (Ve = e).fn[Qe], 
    ze = {
        backdrop: !0,
        keyboard: !0,
        focus: !0,
    ...
    }, "modal-scrollbar-measure", "modal-backdrop", tn = "modal-open", en = "fade", 
    nn = "show", rn = {
        DIALOG: ".modal-dialog",
        ...
        function r(t, e) {
            this._config = this._getConfig(e), this._element = t, this._dialog = Ve(t).find(rn.DIALOG)[0], 
        ...
        return t.toggle = function(t) {
            ...
            if (!this._isTransitioning && !this._isShown) {
                ...
                Ve(this._element).trigger(n), this._isShown || n.isDefaultPrevented() || (this._isShown = !0, 
                this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), Ve(document.body).addClass(tn), 
                this._setEscapeEvent(), this._setResizeEvent(), Ve(this._element).on(Je.CLICK_DISMISS, rn.DATA_DISMISS, function(t) {
                    return e.hide(t);
            ...
            if (t && t.preventDefault(), !this._isTransitioning && this._isShown) {
                ...
                if (Ve(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
                    ...
                    Ve(document).off(Je.FOCUSIN), Ve(this._element).removeClass(nn), Ve(this._element).off(Je.CLICK_DISMISS), 
                    Ve(this._dialog).off(Je.MOUSEDOWN_DISMISS), i) {
            ...
            Ve.removeData(this._element, Ye), Ve(window, document, this._element, this._backdrop).off(Ge), 
            ...
            this._element.scrollTop = 0, n && gt.reflow(this._element), Ve(this._element).addClass(nn), 
            ...
            if (this._isShown && this._config.backdrop) {
                ...
                n && Ve(this._backdrop).addClass(n), Ve(this._backdrop).appendTo(document.body), 
            ...
            Ve(rn.FIXED_CONTENT).each(function(t, e) {
                ...
                void 0 !== n && Ve(e).css("padding-right", n).removeData("padding-right");
            }), Ve(rn.STICKY_CONTENT + ", " + rn.NAVBAR_TOGGLER).each(function(t, e) {
                var n = Ve(e).data("margin-right");
                void 0 !== n && Ve(e).css("margin-right", n).removeData("margin-right");
            });
            var t = Ve(document.body).data("padding-right");
            void 0 !== t && Ve(document.body).css("padding-right", t).removeData("padding-right");
    ...
    }, on), Ci = (an = "tooltip", cn = "." + (ln = "bs.tooltip"), fn = (sn = e).fn[an], 
    hn = "bs-tooltip", un = new RegExp("(^|\\s)" + hn + "\\S+", "g"), gn = {
        animation: !0,
    ...
    }, En = "fade", yn = "show", ".tooltip-inner", ".arrow", Cn = "hover", wn = "focus", 
    "click", "manual", An = function() {
        function i(t, e) {
            if (void 0 === pe) throw new TypeError("Bootstrap tooltips require Popper.js (https://popper.js.org)");
        ...
        return t.enable = function() {
            ...
            sn(this.element).off(this.constructor.EVENT_KEY), sn(this.element).closest(".modal").off("hide.bs.modal"), 
            this.tip && sn(this.tip).remove(), this._isEnabled = null, this._timeout = null, 
            ...
            if (this.isWithContent() && this._isEnabled) {
                ...
                sn(i).data(this.constructor.DATA_KEY, this), sn.contains(this.element.ownerDocument.documentElement, this.tip) || sn(i).appendTo(a), 
                sn(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new pe(this.element, i, {
                    placement: s,
                    modifiers: {
                        offset: {
                ...
                var l = function() {
                    ...
                    var t = e._hoverState;
                    e._hoverState = null, sn(e.element).trigger(e.constructor.Event.SHOWN), "out" === t && e._leave(null, e);
                };
            ...
            var e = this, n = this.getTipElement(), i = sn.Event(this.constructor.Event.HIDE), r = function() {
                e._hoverState !== mn && n.parentNode && n.parentNode.removeChild(n), e._cleanTipClass(), 
                e.element.removeAttribute("aria-describedby"), sn(e.element).trigger(e.constructor.Event.HIDDEN), 
                null !== e._popper && e._popper.destroy(), t && t();
            };
            if (sn(this.element).trigger(i), !i.isDefaultPrevented()) {
                if (sn(n).removeClass(yn), "ontouchstart" in document.documentElement && sn(document.body).children().off("mouseover", null, sn.noop), 
                this._activeTrigger.click = !1, this._activeTrigger[wn] = !1, this._activeTrigger[Cn] = !1, 
            ...
            this.setElementContent(t.find(".tooltip-inner"), this.getTitle()), t.removeClass(En + " " + yn);
            ...
            this.config.trigger.split(" ").forEach(function(t) {
                if ("click" === t) sn(i.element).on(i.constructor.Event.CLICK, i.config.selector, function(t) {
                    ...
                    var e = t === Cn ? i.constructor.Event.MOUSEENTER : i.constructor.Event.FOCUSIN, n = t === Cn ? i.constructor.Event.MOUSELEAVE : i.constructor.Event.FOCUSOUT;
            ...
            sn(t.currentTarget).data(n, e)), t && (e._activeTrigger["focusin" === t.type ? wn : Cn] = !0), 
            sn(e.getTipElement()).hasClass(yn) || e._hoverState === mn ? e._hoverState = mn : (clearTimeout(e._timeout), 
            e._hoverState = mn, e.config.delay && e.config.delay.show ? e._timeout = setTimeout(function() {
                e._hoverState === mn && e.show();
            }, e.config.delay.show) : e.show());
        }, t._leave = function(t, e) {
            var n = this.constructor.DATA_KEY;
            (e = e || sn(t.currentTarget).data(n)) || (e = new this.constructor(t.currentTarget, this._getDelegateConfig()), 
            sn(t.currentTarget).data(n, e)), t && (e._activeTrigger["focusout" === t.type ? wn : Cn] = !1), 
            ...
            gt.typeCheckConfig(an, t, this.constructor.DefaultType), t;
            ...
            null === t.getAttribute("x-placement") && (sn(t).removeClass(En), this.config.animation = !1, 
            this.hide(), this.show(), this.config.animation = e);
        }, i._jQueryInterface = function(n) {
            return this.each(function() {
                var t = sn(this).data(ln), e = "object" == typeof n && n;
                if ((t || !/dispose|hide/.test(n)) && (t || (t = new i(this, e), sn(this).data(ln, t)), 
                "string" == typeof n)) {
                    if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
                    t[n]();
                }
    ...
    }, An), wi = (On = "popover", kn = "." + (Nn = "bs.popover"), Ln = (Sn = e).fn[On], 
    Pn = "bs-popover", xn = new RegExp("(^|\\s)" + Pn + "\\S+", "g"), jn = c({}, Ci.Default, {
        placement: "right",
        trigger: "click",
        content: "",
    ...
    }), "fade", ".popover-header", ".popover-body", Un = {
        HIDE: "hide" + kn,
        HIDDEN: "hidden" + kn,
        SHOW: "show" + kn,
        SHOWN: "shown" + kn,
        ...
        return r.isWithContent = function() {
            ...
            return this.each(function() {
                ...
                if ((t || !/destroy|hide/.test(n)) && (t || (t = new i(this, e), Sn(this).data(Nn, t)), 
                "string" == typeof n)) {
                    if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
                    t[n]();
                }
    ...
    }, Bn), Ii = (Vn = "scrollspy", Yn = "." + (Qn = "bs.scrollspy"), Gn = (Kn = e).fn[Vn], 
    qn = {
        offset: 10,
        method: "auto",
        target: ""
    ...
    }, "offset", ei = "position", ni = function() {
        function n(t, e) {
            var n = this;
        ...
        return t.refresh = function() {
            var e = this, t = this._scrollElement === this._scrollElement.window ? "offset" : ei, r = "auto" === this._config.method ? t : this._config.method, o = r === ei ? this._getScrollTop() : 0;
            ...
            Kn.removeData(this._element, Qn), Kn(this._scrollElement).off(Yn), this._element = null, 
            ...
            var n = Kn(t.join(","));
            n.hasClass("dropdown-item") ? (n.closest($n.DROPDOWN).find($n.DROPDOWN_TOGGLE).addClass(Zn), 
            n.addClass(Zn)) : (n.addClass(Zn), n.parents($n.NAV_LIST_GROUP).prev($n.NAV_LINKS + ", " + $n.LIST_ITEMS).addClass(Zn), 
    ...
    }, "dropdown-menu", ci = "active", "disabled", "fade", "show", ".dropdown", ".nav, .list-group", 
    gi = ".active", mi = "> li > .active", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', 
    ".dropdown-toggle", "> .dropdown-menu .active", yi = function() {
        function i(t) {
            this._element = t;
        }
        var t = i.prototype;
        return t.show = function() {
            var n = this;
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && ii(this._element).hasClass(ci) || ii(this._element).hasClass("disabled"))) {
                var t, i, e = ii(this._element).closest(".nav, .list-group")[0], r = gt.getSelectorFromElement(this._element);
                if (e) {
            ...
            var i = this, r = ("UL" === e.nodeName ? ii(e).find(mi) : ii(e).children(gi))[0], o = n && r && ii(r).hasClass("fade"), s = function() {
            ...
            if (e) {
                ii(e).removeClass("show " + ci);
                var i = ii(e.parentNode).find("> .dropdown-menu .active")[0];
                i && ii(i).removeClass(ci), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !1);
            }
            if (ii(t).addClass(ci), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), 
            gt.reflow(t), ii(t).addClass("show"), t.parentNode && ii(t.parentNode).hasClass("dropdown-menu")) {
                var r = ii(t).closest(".dropdown")[0];
                r && ii(r).find(".dropdown-toggle").addClass(ci), t.setAttribute("aria-expanded", !0);
            }
            n && n();
        }, i._jQueryInterface = function(n) {
            return this.each(function() {
    ...
    }(), ii(document).on(ai.CLICK_DATA_API, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(t) {
    ...
    t.Dropdown = bi, t.Modal = Ti, t.Popover = wi, t.Scrollspy = Ii, t.Tab = Di, t.Tooltip = Ci, 
    ...
    !function(a) {
        ...
        "use strict";
        var f, g, h, i, j, k, l, m, n, o, q, r, s, t, u, v, w, x, y, z, A, B, C, D, G, H, I, J, K, e = {}, L = 0;
        f = function() {
            return {
                common: {
                    type: "line",
            ...
            }, 1 < arguments.length ? (arguments[0] ? (a.prototype = d.extend(new arguments[0](), arguments[arguments.length - 1]), 
            a._super = arguments[0].prototype) : a.prototype = arguments[arguments.length - 1], 
            2 < arguments.length && ((b = Array.prototype.slice.call(arguments, 1, -1)).unshift(a.prototype), 
            d.extend.apply(d, b))) : a.prototype = arguments[0], a.prototype.cls = a;
        }, d.SPFormatClass = h = g({
            fre: /\{\{([\w.]+?)(:(.+?))?\}\}/g,
            precre: /(\w+)\.(\d+)/,
            init: function(a, b) {
            ...
            render: function(a, b, d) {
                ...
                return this.format.replace(this.fre, function() {
                    return h = arguments[1], i = arguments[3], (g = e.precre.exec(h)) ? (k = g[2], h = g[1]) : k = !1, 
                    (j = f[h]) === c ? "" : i && b && b[i] ? b[i].get ? b[i].get(j) || j : b[i][j] || j : (n(j) && (j = d.get("numberFormatter") ? d.get("numberFormatter")(j) : s(j, k, d.get("numberDigitGroupCount"), d.get("numberDigitGroupSep"), d.get("numberDecimalMark"))), 
                    j);
                });
            }
            ...
            var d;
            return 2 === c ? (d = b.floor(a.length / 2), a.length % 2 ? a[d] : (a[d - 1] + a[d]) / 2) : (d = a.length % 2 ? (a.length * c + c) / 4 : (a.length * c + 2) / 4) % 1 ? (a[b.floor(d)] + a[b.floor(d) - 1]) / 2 : a[d - 1];
        }, k = function(a) {
            var b;
            switch (a) {
              case "undefined":
            ...
            var g, h;
            for (a = (!1 === b ? parseFloat(a).toString() : a.toFixed(b)).split(""), (g = (g = d.inArray(".", a)) < 0 ? a.length : g) < a.length && (a[g] = f), 
            h = g - c; 0 < h; h -= c) a.splice(h, 0, e);
            return a.join("");
        }, o = function(a, b, c) {
            var d;
            ...
            var c;
            a.createStyleSheet ? a.createStyleSheet().cssText = b : ((c = a.createElement("style")).type = "text/css", 
            a.getElementsByTagName("head")[0].appendChild(c), c["string" == typeof a.body.style.WebkitAppearance ? "innerText" : "innerHTML"] = b);
            ...
            h = d.fn.sparkline.canvas(b, e, this, g), (i = d(this).data("_jqs_mhandler")) && i.registerCanvas(h), 
            h;
            ...
            init: function(a) {
                var b, c, d = [];
                for (b in a) a.hasOwnProperty(b) && "string" == typeof b && -1 < b.indexOf(":") && ((c = b.split(":"))[0] = 0 === c[0].length ? -1 / 0 : parseFloat(c[0]), 
                c[1] = 0 === c[1].length ? 1 / 0 : parseFloat(c[1]), c[2] = a[b], d.push(c));
                this.map = a, this.rangelist = d || !1;
            },
            get: function(a) {
                var d, e, f, b = this.rangelist;
                if ((f = this.map[a]) !== c) return f;
                if (b) for (d = b.length; d--; ) if ((e = b[d])[0] <= a && e[1] >= a) return e[2];
                return c;
            }
            ...
            registerCanvas: function(a) {
                var b = d(a.canvas);
                this.canvas = a, (this.$canvas = b).mouseenter(d.proxy(this.mouseenter, this)), 
            ...
            mouseleave: function() {
                ...
                var g, b = this.splist, c = b.length, e = !1;
                for (this.over = !1, this.currentEl = null, this.tooltip && (this.tooltip.remove(), 
                this.tooltip = null), g = 0; g < c; g++) b[g].clearRegionHighlight() && (e = !0);
            ...
            updateDisplay: function() {
                var h, j, k, l, a = this.splist, b = a.length, c = !1, e = this.$canvas.offset(), f = this.currentPageX - e.left, g = this.currentPageY - e.top;
                if (this.over) {
                    for (j = 0; j < b; j++) (k = a[j].setRegionHighlight(this.currentEl, f, g)) && (c = !0);
                    if (c) {
                        if ((l = d.Event("sparklineRegionChange")).sparklines = this.splist, this.$el.trigger(l), 
                        this.tooltip) {
                            for (h = "", j = 0; j < b; j++) h += a[j].getCurrentRegionTooltip();
            ...
            q('.jqstooltip { position: absolute;left: 0px;top: 0px;visibility: hidden;background: rgb(0, 0, 0) transparent;background-color: rgba(0,0,0,0.6);filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=#99000000, endColorstr=#99000000);-ms-filter: "progid:DXImageTransform.Microsoft.gradient(startColorstr=#99000000, endColorstr=#99000000)";color: white;font: 10px arial, san serif;text-align: left;white-space: nowrap;padding: 5px;border: 1px solid white;z-index: 10000;}.jqsfield { color: white;font: 10px arial, san serif;text-align: left;}');
        }), K = [], d.fn.sparkline = function(b, e) {
            return this.each(function() {
                var h, i, f = new d.fn.sparkline.options(this, e), g = d(this);
                if (h = function() {
                    var e, h, i, j, k, l, m;
                    "html" === b || b === c ? ((m = this.getAttribute(f.get("tagValuesAttribute"))) !== c && null !== m || (m = g.html()), 
                    e = m.replace(/(^\s*<!--)|(-->\s*$)|\s+/g, "").split(",")) : e = b, h = "auto" === f.get("width") ? e.length * f.get("defaultPixelsPerValue") : f.get("width"), 
                    "auto" === f.get("height") ? f.get("composite") && d.data(this, "_jqs_vcanvas") || ((j = a.createElement("span")).innerHTML = "a", 
                    g.html(j), i = d(j).innerHeight() || d(j).height(), d(j).remove(), j = null) : i = f.get("height"), 
                    f.get("disableInteraction") ? k = !1 : (k = d.data(this, "_jqs_mhandler")) ? f.get("composite") || k.reset() : (k = new u(this, f), 
                    d.data(this, "_jqs_mhandler", k)), !f.get("composite") || d.data(this, "_jqs_vcanvas") ? ((l = new (d.fn.sparkline[f.get("type")])(this, e, f, h, i)).render(), 
                    k && k.registerSparkline(l)) : d.data(this, "_jqs_errnotify") || (alert("Attempted to attach a composite sparkline to an element with no existing sparkline"), 
            ...
            var a, b, c, e = [];
            for (b = 0, c = K.length; b < c; b++) a = K[b][0], d(a).is(":visible") && !d(a).parents().is(":hidden") ? (K[b][1].call(a), 
            ...
            init: function(a, b) {
                var c, f, g, h;
                this.userOptions = b = b || {}, this.tag = a, this.tagValCache = {}, g = (f = d.fn.sparkline.defaults).common, 
                this.tagOptionsPrefix = b.enableTagOptions && (b.tagOptionsPrefix || g.tagOptionsPrefix), 
                c = (h = this.getTagSetting("type")) === e ? f[b.type || g.type] : f[h], this.mergedOptions = d.extend({}, g, c, b);
            },
            getTagSetting: function(a) {
                ...
                if (this.tagValCache.hasOwnProperty(a)) d = this.tagValCache.key; else {
                    if ((d = this.tag.getAttribute(b + a)) === c || null === d) d = e; else if ("[" === d.substr(0, 1)) for (f = (d = d.substr(1, d.length - 2).split(",")).length; f--; ) d[f] = k(d[f].replace(/(^\s*)|(\s*$)/g, "")); else if ("{" === d.substr(0, 1)) for (g = d.substr(1, d.length - 2).split(","), 
                    d = {}, f = g.length; f--; ) d[(h = g[f].split(":", 2))[0].replace(/(^\s*)|(\s*$)/g, "")] = k(h[1].replace(/(^\s*)|(\s*$)/g, "")); else d = k(d);
            ...
            setRegionHighlight: function(a, b, d) {
                ...
                return b > this.canvasWidth || d > this.canvasHeight || b < 0 || d < 0 ? null : e !== (g = this.getRegion(a, b, d)) && (e !== c && f && this.removeHighlight(), 
                (this.currentRegion = g) !== c && f && this.renderHighlight(), !0);
            },
            ...
            getCurrentRegionTooltip: function() {
                ...
                !(g = this.options.get("tooltipFormat"))) return "";
                ...
                for (i = g.length, s = f.length, l = 0; l < i; l++) for ("string" == typeof (r = g[l]) && (r = new h(r)), 
                j = r.fclass || "jqsfield", t = 0; t < s; t++) f[t].isNull && a.get("tooltipSkipNull") || (d.extend(f[t], {
            ...
            calcHighlightColor: function(a, c) {
                ...
                if (e && (f = /^#([0-9a-f])([0-9a-f])([0-9a-f])$/i.exec(a) || /^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(a))) {
                    for (h = [], g = 4 === a.length ? 16 : 1, j = 0; j < 3; j++) h[j] = i(b.round(parseInt(f[j + 1], 16) * g * e), 0, 255);
                    return "rgb(" + h.join(",") + ")";
                }
                return a;
            }
            ...
            scanValues: function() {
                ...
                for (g = 0; g < c; g++) h = a[g], i = "string" == typeof a[g], j = "object" == typeof a[g] && a[g] instanceof Array, 
            ...
            render: function() {
                var k, l, m, n, o, p, q, r, s, u, v, w, z, A, B, C, D, E, F, G, H, I, J, K, a = this.options, e = this.target, f = this.canvasWidth, g = this.canvasHeight, h = this.vertices, i = a.get("spotRadius"), j = this.regionMap;
                ...
                I = this.xvalues, J = this.yvalues, this.yminmax.length && !(this.yvalues.length < 2))) {
                    ...
                    m = this.yvalues.length - 1, i && (f < 4 * i || g < 4 * i) && (i = 0), i && (((G = a.get("highlightSpotColor") && !a.get("disableInteraction")) || a.get("minSpotColor") || a.get("spotColor") && J[m] === this.miny) && (g -= b.ceil(i)), 
                    ...
                    r = [ q = [] ], z = A = null, B = J.length, K = 0; K < B; K++) s = I[K], v = I[K + 1], 
                    u = J[K], A = (w = o + b.round((s - this.minx) * (f / k))) + ((K < B - 1 ? o + b.round((v - this.minx) * (f / k)) : f) - w) / 2, 
                    j[K] = [ z || 0, A, K ], z = A, null === u ? K && (null !== J[K - 1] && (q = [], 
                    ...
                    q.push(p), h.push(p));
                    for (C = [], D = [], E = r.length, K = 0; K < E; K++) (q = r[K]).length && (a.get("fillColor") && (q.push([ q[q.length - 1][0], n + g ]), 
                    D.push(q.slice(0)), q.pop()), 2 < q.length && (q[0] = [ q[0][0], q[1][1] ]), C.push(q));
                    for (E = D.length, K = 0; K < E; K++) e.drawShape(D[K], a.get("fillColor"), a.get("fillColor")).append();
                    for (a.get("normalRangeMin") !== c && a.get("drawNormalOnTop") && this.drawNormalRange(o, n, g, f, l), 
                    E = C.length, K = 0; K < E; K++) e.drawShape(C[K], a.get("lineColor"), c, a.get("lineWidth")).append();
                    if (i && a.get("valueSpots")) for ((F = a.get("valueSpots")).get === c && (F = new t(F)), 
                    K = 0; K < B; K++) (H = F.get(J[K])) && e.drawCircle(o + b.round((I[K] - this.minx) * (f / k)), n + b.round(g - g * ((J[K] - this.miny) / l)), i, c, H).append();
            ...
            init: function(a, e, f, g, h) {
                var u, v, w, x, z, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, j = parseInt(f.get("barWidth"), 10), n = parseInt(f.get("barSpacing"), 10), o = f.get("chartRangeMin"), p = f.get("chartRangeMax"), q = f.get("chartRangeClip"), r = 1 / 0, s = -1 / 0;
                for (y._super.init.call(this, a, e, f, g, h), A = 0, B = e.length; A < B; A++) ((u = "string" == typeof (O = e[A]) && -1 < O.indexOf(":")) || d.isArray(O)) && (J = !0, 
                u && (O = e[A] = l(O.split(":"))), O = m(O, null), (v = b.min.apply(b, O)) < r && (r = v), 
                s < (w = b.max.apply(b, O)) && (s = w));
                ...
                x = J ? [] : z;
                var S = [], T = [];
                for (A = 0, B = e.length; A < B; A++) if (J) for (K = e[A], e[A] = N = [], S[A] = 0, 
                x[A] = T[A] = 0, L = 0, M = K.length; L < M; L++) null !== (O = N[L] = q ? i(K[L], H, I) : K[L]) && (0 < O && (S[A] += O), 
                r < 0 && 0 < s ? O < 0 ? T[A] += b.abs(O) : x[A] += O : x[A] += b.abs(O - (O < 0 ? s : r)), 
                z.push(O)); else O = q ? i(e[A], H, I) : e[A], null !== (O = e[A] = k(O)) && z.push(O);
                ...
                this.zeroAxis = D = f.get("zeroAxis", !0), E = F <= 0 && 0 <= G && D ? 0 : 0 == D ? F : 0 < F ? F : G, 
                this.xaxisOffset = E, C = J ? b.max.apply(b, x) + b.max.apply(b, T) : G - F, this.canvasHeightEf = D && F < 0 ? this.canvasHeight - 2 : this.canvasHeight - 1, 
                F < E ? (P = ((J && 0 <= G ? s : G) - E) / C * this.canvasHeight) !== b.ceil(P) && (this.canvasHeightEf -= 2, 
            ...
            calcColor: function(a, b, e) {
                ...
                return i = this.stacked ? h.get("stackedBarColor") : b < 0 ? h.get("negBarColor") : h.get("barColor"), 
            ...
            renderRegion: function(a, e) {
                ...
                if (w = (f = d.isArray(f) ? f : [ f ]).length, x = f[0], t = o(null, f), z = o(h, f, !0), 
                t) return g.get("nullColor") ? (s = e ? g.get("nullColor") : this.calcHighlightColor(g.get("nullColor"), g), 
                q = 0 < p ? p - 1 : p, l.drawRect(m, q, this.barWidth - 1, 0, s, s)) : c;
                for (u = p, v = 0; v < w; v++) {
                    if (x = f[v], k && x === h) {
                        if (!z || y) continue;
                        y = !0;
                    }
                    r = 0 < j ? b.floor(n * (b.abs(x - h) / j)) + 1 : 1, x < h || x === h && 0 === p ? (q = u, 
            ...
            calcColor: function(a, b) {
                var h, c = this.values, d = this.options, e = this.colorMapByIndex, f = this.colorMapByValue;
                return f && (h = f.get(a)) ? h : e && e.length > b ? e[b] : c[b] < 0 ? d.get("negBarColor") : 0 < c[b] ? d.get("posBarColor") : d.get("zeroBarColor");
            },
            renderRegion: function(a, c) {
                var g, h, i, j, k, l, d = this.values, e = this.options, f = this.target;
                if (g = f.pixelHeight, i = b.round(g / 2), j = a * this.totalBarWidth, d[a] < 0 ? h = (k = i) - 1 : 0 < d[a] ? (k = 0, 
                h = i - 1) : (k = i - 1, h = 2), null !== (l = this.calcColor(d[a], a))) return c && (l = this.calcHighlightColor(l, e)), 
            ...
            renderRegion: function(a, c) {
                ...
                return p = i(d[a], f, g), r = a * j, o = b.round(n - n * ((p - f) / h)), q = e.get("thresholdColor") && p < e.get("thresholdValue") ? e.get("thresholdColor") : e.get("lineColor"), 
            ...
            init: function(a, d, e, f, g) {
                var h, i, j;
                B._super.init.call(this, a, d, e, f, g), this.values = d = l(d), (j = d.slice())[0] = null === j[0] ? j[2] : j[0], 
                j[1] = null === d[1] ? j[2] : j[1], h = b.min.apply(b, d), i = b.max.apply(b, d), 
                h = e.get("base") === c ? h < 0 ? h : 0 : e.get("base"), this.min = h, this.max = i, 
                this.range = i - h, this.shapes = {}, this.valueShapes = {}, this.regiondata = {}, 
                this.width = f = "auto" === e.get("width") ? "4.0em" : f, this.target = this.$el.simpledraw(f, g, e.get("composite")), 
            ...
            init: function(a, c, e, f, g) {
                ...
                0 < c.length) for (i = c.length; i--; ) h += c[i];
            ...
            renderSlice: function(a, d) {
                ...
                for (q = k.length, p = 0; p < q; p++) {
                    if (o = n = m, 0 < l && (o = m + j * (k[p] / l)), a === p) return r = f.get("sliceColors")[p % f.get("sliceColors").length], 
            ...
            render: function() {
                ...
                if (D._super.render.call(this)) {
                    if (f.get("raw")) f.get("showOutliers") && 5 < d.length ? (n = d[0], m = d[1], p = d[2], 
                    q = d[3], r = d[4], s = d[5], t = d[6]) : (m = d[0], p = d[1], q = d[2], r = d[3], 
                    s = d[4]); else if (d.sort(function(a, b) {
                        return a - b;
                    }), p = j(d, 1), q = j(d, 2), o = (r = j(d, 3)) - p, f.get("showOutliers")) {
                        for (m = s = c, u = 0; u < e; u++) m === c && d[u] > p - o * f.get("outlierIQR") && (m = d[u]), 
                    ...
                    w = (g -= 2 * b.ceil(f.get("spotRadius"))) / (k - i + 1), n < m && a.drawCircle((n - i) * w + l, h / 2, f.get("spotRadius"), f.get("outlierLineColor"), f.get("outlierFillColor")).append(), 
                    s < t && a.drawCircle((t - i) * w + l, h / 2, f.get("spotRadius"), f.get("outlierLineColor"), f.get("outlierFillColor")).append()), 
            ...
            reset: function() {
                ...
                this.shapeseq = [], this.currentTargetShapeId = c;
            },
            _drawShape: function(a, b, d, e, f) {
                var h, i, g = this._getContext(d, e, f);
                for (g.beginPath(), g.moveTo(b[0][0] + .5, b[0][1] + .5), h = 1, i = b.length; h < i; h++) g.lineTo(b[h][0] + .5, b[h][1] + .5);
            ...
            replaceWithShapes: function(a, b) {
                ...
                for (f = c.length; f--; ) d[e = c[f]] && (c.splice(f, 1), delete this.shapes[e], 
                g = f);
            ...
            render: function() {
                var f, g, a = this.shapeseq, b = this.shapes, c = a.length;
                for (this._getContext().clearRect(0, 0, this.pixelWidth, this.pixelHeight), g = 0; g < c; g++) this["_draw" + (f = b[a[g]]).type].apply(this, f.args);
            ...
            _drawShape: function(a, b, d, e, f) {
                ...
                '<v:shape coordorigin="0 0" coordsize="' + this.pixelWidth + " " + this.pixelHeight + '"  id="jqsshape' + a + '" ' + i + j + ' style="position:absolute;left:0px;top:0px;height:' + this.pixelHeight + "px;width:" + this.pixelWidth + 'px;padding:0px;margin:0px;"  path="m ' + h + " l " + g.join(", ") + " " + k + 'e"> </v:shape>';
            },
            _drawCircle: function(a, b, d, e, f, g, h) {
                return '<v:oval  id="jqsshape' + a + '" ' + (f === c ? ' stroked="false" ' : ' strokeWeight="' + h + 'px" strokeColor="' + f + '" ') + (g === c ? ' filled="false"' : ' fillColor="' + g + '" filled="true" ') + ' style="position:absolute;top:' + (d -= e) + "px; left:" + (b -= e) + "px; width:" + 2 * e + "px; height:" + 2 * e + 'px"></v:oval>';
            },
            _drawPieSlice: function(a, d, e, f, g, h, i, j) {
                var k, l, m, n, o, p, q;
                if (g === h) return "";
                if (h - g == 2 * b.PI && (g = 0, h = 2 * b.PI), l = d + b.round(b.cos(g) * f), m = e + b.round(b.sin(g) * f), 
                n = d + b.round(b.cos(h) * f), o = e + b.round(b.sin(h) * f), l === n && m === o) {
                    if (h - g < b.PI) return "";
                    l = n = d + f, m = o = e;
                }
                return l === n && m === o && h - g < b.PI ? "" : (k = [ d - f, e - f, d + f, e + f, l, m, n, o ], 
                p = i === c ? ' stroked="false" ' : ' strokeWeight="1px" strokeColor="' + i + '" ', 
                q = j === c ? ' filled="false"' : ' fillColor="' + j + '" filled="true" ', '<v:shape coordorigin="0 0" coordsize="' + this.pixelWidth + " " + this.pixelHeight + '"  id="jqsshape' + a + '" ' + p + q + ' style="position:absolute;left:0px;top:0px;height:' + this.pixelHeight + "px;width:" + this.pixelWidth + 'px;padding:0px;margin:0px;"  path="m ' + d + "," + e + " wa " + k.join(", ") + ' x e"> </v:shape>');
            },
            _drawRect: function(a, b, c, d, e, f, g) {
    ...
    e.fn.vectorMap = function(e) {
        ...
        if ("addMap" === e) jvm.WorldMap.maps[arguments[1]] = arguments[2]; else {
            if (("set" === e || "get" === e) && t[e][arguments[1]]) return n[e + (arguments[1].charAt(0).toUpperCase() + arguments[1].substr(1))].apply(n, Array.prototype.slice.call(arguments, 2));
            (e = e || {}).container = this, n = new jvm.WorldMap(e);
        }
        return this;
    };
}(jQuery), function(e) {
    function r(t) {
        ...
        return (t = e.event.fix(n)).type = "mousewheel", n.wheelDelta && (i = n.wheelDelta / 120), 
...
var jvm = {
    inherits: function(e, t) {
        function n() {}
        n.prototype = t.prototype, e.prototype = new n(), (e.prototype.constructor = e).parentClass = t;
    },
    mixin: function(e, t) {
        var n;
    ...
    values: function(e) {
        var n, r, t = [];
        for (r = 0; r < arguments.length; r++) for (n in e = arguments[r]) t.push(e[n]);
        return t;
    }
};
...
jvm.VMLCanvasElement.prototype.setSize = function(e, t) {
    ...
    this.node.coordsize = e + " " + t, this.node.coordorigin = "0 0", this.rootElement) {
        for (i = 0, s = (n = this.rootElement.node.getElementsByTagName("shape")).length; i < s; i++) n[i].coordsize = e + " " + t, 
        n[i].style.width = e + "px", n[i].style.height = t + "px";
        for (i = 0, s = (r = this.node.getElementsByTagName("group")).length; i < s; i++) r[i].coordsize = e + " " + t, 
...
jvm.VMLShapeElement.prototype.applyAttr = function(e, t) {
    ...
    var i, s, n = 0, r = 0;
    return (e = e.replace(/(-?\d+)e(-?\d+)/g, "0")).replace(/([MmLlHhVvCcSs])\s*((?:-?\d*(?:\.\d+)?\s*,?\s*)+)/g, function(e, t, o, u) {
    ...
    return this.mode = window.SVGAngle ? "svg" : "vml", "svg" == this.mode ? this.impl = new jvm.SVGCanvasElement(e, t, n) : this.impl = new jvm.VMLCanvasElement(e, t, n), 
    this.impl;
    ...
    getValue: function(e) {
        ...
        for (i = 0, e -= this.minValue; 0 <= e - t[i]; ) e -= t[i], i++;
    ...
    var n, r, t = "#";
    for (r = 0; r < e.length; r++) t += 1 == (n = e[r].toString(16)).length ? "0" + n : n;
    return t;
    ...
    var n;
    (e = e || {}).attribute = e.attribute || "fill", this.elements = t, (this.params = e).attributes && this.setAttributes(e.attributes), 
    jvm.$.isArray(e.scale) ? (n = "fill" === e.attribute || "stroke" === e.attribute ? jvm.ColorScale : jvm.NumericScale, 
    ...
    setValues: function(e) {
        ...
        if (this.scale instanceof jvm.OrdinalScale || this.scale instanceof jvm.SimpleScale) for (i in e) e[i] ? s[i] = this.scale.getValue(e[i]) : s[i] = this.elements[i].element.style.initial[this.params.attribute]; else {
            if (!this.params.min || !this.params.max) {
                for (i in e) t < (r = parseFloat(e[i])) && (t = e[i]), r < n && (n = r);
    ...
    aea: function(e, t, n) {
        var i = n * this.radDeg, s = 29.5 * this.radDeg, o = 45.5 * this.radDeg, u = e * this.radDeg, a = t * this.radDeg, f = (Math.sin(s) + Math.sin(o)) / 2, l = Math.cos(s) * Math.cos(s) + 2 * f * Math.sin(s), c = f * (a - i), h = Math.sqrt(l - 2 * f * Math.sin(u)) / f, p = Math.sqrt(l - 2 * f * Math.sin(0)) / f;
        return {
    ...
    aea_inv: function(e, t, n) {
        var r = e / this.radius, i = t / this.radius, o = n * this.radDeg, u = 29.5 * this.radDeg, a = 45.5 * this.radDeg, f = (Math.sin(u) + Math.sin(a)) / 2, l = Math.cos(u) * Math.cos(u) + 2 * f * Math.sin(u), c = Math.sqrt(l - 2 * f * Math.sin(0)) / f, h = Math.sqrt(r * r + (c - i) * (c - i)), p = Math.atan(r / (c - i));
        return {
    ...
    lcc: function(e, t, n) {
        var i = n * this.radDeg, s = t * this.radDeg, o = 33 * this.radDeg, u = 45 * this.radDeg, a = e * this.radDeg, f = Math.log(Math.cos(o) * (1 / Math.cos(u))) / Math.log(Math.tan(Math.PI / 4 + u / 2) * (1 / Math.tan(Math.PI / 4 + o / 2))), l = Math.cos(o) * Math.pow(Math.tan(Math.PI / 4 + o / 2), f) / f, c = l * Math.pow(1 / Math.tan(Math.PI / 4 + a / 2), f), h = l * Math.pow(1 / Math.tan(Math.PI / 4 + 0), f);
        return {
    ...
    lcc_inv: function(e, t, n) {
        var r = e / this.radius, i = t / this.radius, o = n * this.radDeg, u = 33 * this.radDeg, a = 45 * this.radDeg, f = Math.log(Math.cos(u) * (1 / Math.cos(a))) / Math.log(Math.tan(Math.PI / 4 + a / 2) * (1 / Math.tan(Math.PI / 4 + u / 2))), l = Math.cos(u) * Math.pow(Math.tan(Math.PI / 4 + u / 2), f) / f, c = l * Math.pow(1 / Math.tan(Math.PI / 4 + 0), f), h = this.sgn(f) * Math.sqrt(r * r + (c - i) * (c - i)), p = Math.atan(r / (c - i));
        return {
    ...
    for (n in this.mapData = jvm.WorldMap.maps[this.params.map], this.markers = {}, 
    this.regions = {}, this.regionsColors = {}, this.regionsData = {}, this.container = jvm.$("<div>").css({
        width: "100%",
        height: "100%"
    ...
    this.setBackgroundColor(this.params.backgroundColor), this.onResize = function() {
        t.setSize();
    }, jvm.$(window).resize(this.onResize), jvm.WorldMap.apiEvents) this.params[n] && this.container.bind(jvm.WorldMap.apiEvents[n] + ".jvectormap", this.params[n]);
    ...
    bindElementEvents: function() {
        ...
        this.container.mousemove(function() {
            ...
            var s = -1 === (jvm.$(this).attr("class").baseVal ? jvm.$(this).attr("class").baseVal : jvm.$(this).attr("class")).indexOf("jvectormap-region") ? "marker" : "region", o = "region" == s ? jvm.$(this).attr("data-code") : jvm.$(this).attr("data-index"), u = jvm.$.Event(s + "Click.jvectormap"), a = "region" == s ? e.regions[o].element : e.markers[o].element;
    ...
    setScale: function(e, t, n, r) {
        ...
        void 0 !== t && void 0 !== n && (i = e / this.scale, r ? (this.transX = t + this.defaultWidth * (this.width / (this.defaultWidth * e)) / 2, 
    ...
    setFocus: function(e, t, n) {
        ...
        if (jvm.$.isArray(e) || this.regions[e]) {
            for (o = jvm.$.isArray(e) ? e : [ e ], u = 0; u < o.length; u++) this.regions[o[u]] && ((i = this.regions[o[u]].element.getBBox()) && (void 0 === r ? r = i : r = {
                x: Math.min(r.x, i.x),
                y: Math.min(r.y, i.y),
    ...
    createMarkers: function(e) {
        ...
        for (t in e) i = e[t] instanceof Array ? {
            latLng: e[t]
        } : e[t], !1 !== (r = this.getMarkerPosition(i)) && ((n = this.canvas.addCircle({
            "data-index": t,
            cx: r.x,
            cy: r.y
        }, jvm.$.extend(!0, {}, this.params.markerStyle, {
            initial: i.style || {}
        }), this.markersGroup)).addClass("jvectormap-marker jvectormap-element"), jvm.$(n.node).bind("selected", function(e, t) {
    ...
    addMarker: function(e, t, n) {
        var s, o, r = {}, i = [];
        n = n || [];
        for (r[e] = t, o = 0; o < n.length; o++) (s = {})[e] = n[o], i.push(s);
        this.addMarkers(r, i);
    },
    ...
    latLngToPoint: function(e, t) {
        ...
        this.width, this.baseTransX, this.baseScale, this.height, this.baseTransY, this.baseScale, 
        this.scale, this.baseScale;
        return t < -180 + i && (t += 360), n = jvm.Proj[r.type](e, t, i), !!(u = this.getInsetForPoint(n.x, n.y)) && (a = u.bbox, 
        n.x = (n.x - a[0].x) / (a[1].x - a[0].x) * u.width * this.scale, n.y = (n.y - a[0].y) / (a[1].y - a[0].y) * u.height * this.scale, 
        {
    ...
    pointToLatLng: function(e, t) {
        ...
        for (s = 0; s < i.length; s++) if (u = (o = i[s]).bbox, a = e - (this.transX * this.scale + o.left * this.scale), 
    ...
    getInsetForPoint: function(e, t) {
        ...
        for (r = 0; r < n.length; r++) if (e > (i = n[r].bbox)[0].x && e < i[1].x && t > i[0].y && t < i[1].y) return n[r];
    },
    createSeries: function() {
        ...
        for (t in this.series = {
            markers: [],
            regions: []
        }, this.params.series) for (e = 0; e < this.params.series[t].length; e++) this.series[t][e] = new jvm.DataSeries(this.params.series[t][e], this[t]);
    },
    remove: function() {
    ...
    "object" == typeof exports ? module.exports = factory(require("jquery")) : "function" == typeof define && define.amd ? define([ "jquery" ], factory) : factory(jQuery);
}(function($) {
    "use strict";
    ...
    k.c = {}, k.c.d = $(document), k.c.t = function(e) {
        ...
        this.relativeHeight = !1, this.$div = null, this.run = function() {
            ...
            if (!this.$.data("kontroled")) {
                ...
                this.copy(this.v, this.cv)) : this.cv = this.v, this.$.bind("configure", cf).parent().bind("configure", cf), 
            ...
            var touchMove = function(e) {
                ...
                v != s.cv && (s.cH && !1 === s.cH(v) || (s.change(s._validate(v)), s._draw()));
            };
            ...
            return mouseMove(e), k.c.d.bind("mousemove.k", mouseMove).bind("keyup.k", function(e) {
                if (27 === e.keyCode) {
                    if (k.c.d.unbind("mouseup.k mousemove.k keyup.k"), s.eH && !1 === s.eH()) return;
                    s.cancel();
                }
        ...
        this.change = function(v) {}, this.val = function(v) {}, this.xy2val = function(x, y) {}, 
        this.draw = function() {}, this.clear = function() {
            this._clear();
        }, this.h2rgba = function(h, a) {
            var rgb;
            return h = h.substring(1, 7), "rgba(" + (rgb = [ parseInt(h.substring(0, 2), 16), parseInt(h.substring(2, 4), 16), parseInt(h.substring(4, 6), 16) ])[0] + "," + rgb[1] + "," + rgb[2] + "," + a + ")";
        }, this.copy = function(f, t) {
            for (var i in f) t[i] = f[i];
        };
    }, k.Dial = function() {
        k.o.call(this), this.startAngle = null, this.xy = null, this.radius = null, this.lineWidth = null, 
        this.cursorExt = null, this.w2 = null, this.PI2 = 2 * Math.PI, this.extend = function() {
            ...
            v = this.o.parse(v), !1 !== triggerRelease && v != this.v && this.rH && !1 === this.rH(v) || (this.cv = this.o.stopper ? max(min(v, this.o.max), this.o.min) : v, 
            ...
            this.o.flip && (a = this.angleArc - a - this.PI2), this.angleArc != this.PI2 && a < 0 && -.5 < a ? a = 0 : a < 0 && (a += this.PI2), 
            ret = a * (this.o.max - this.o.min) / this.angleArc + this.o.min, this.o.stopper && (ret = max(min(ret, this.o.max), this.o.min)), 
            ret;
        }, this.listen = function() {
            var mwTimerStop, mwTimerRelease, kval, to, s = this, mw = function(e) {
                e.preventDefault();
                var ori = e.originalEvent, deltaX = ori.detail || ori.wheelDeltaX, deltaY = ori.detail || ori.wheelDeltaY, v = s._validate(s.o.parse(s.$.val())) + (0 < deltaX || 0 < deltaY ? s.o.step : deltaX < 0 || deltaY < 0 ? -s.o.step : 0);
                v = max(min(v, s.o.max), s.o.min), s.val(v, !1), s.rH && (clearTimeout(mwTimerStop), 
            ...
            this.$.bind("keydown", function(e) {
                var kc = e.keyCode;
                if (96 <= kc && kc <= 105 && (kc = e.keyCode = kc - 48), kval = parseInt(String.fromCharCode(kc)), 
                isNaN(kval) && (13 !== kc && 8 !== kc && 9 !== kc && 189 !== kc && (190 !== kc || s.$.val().match(/\./)) && e.preventDefault(), 
                -1 < $.inArray(kc, [ 37, 38, 39, 40 ]))) {
                    e.preventDefault();
                    var v = s.o.parse(s.$.val()) + kv[kc] * m;
                    s.o.stopper && (v = max(min(v, s.o.max), s.o.min)), s.change(s._validate(v)), s._draw(), 
            ...
            var sa, ea;
            return v = this.angle(v), ea = this.o.flip ? (sa = this.endAngle + 1e-5) - v - 1e-5 : (sa = this.startAngle - 1e-5) + v + 1e-5, 
            this.o.cursor && (sa = ea - this.cursorExt) && (ea += this.cursorExt), {
                s: sa,
                e: ea,
                d: this.o.flip && !this.o.cursor
            };
        }, this.draw = function() {
            var pa, c = this.g, a = this.arc(this.cv), r = 1;
            c.lineWidth = this.lineWidth, c.lineCap = this.lineCap, "none" !== this.o.bgColor && (c.beginPath(), 
            c.strokeStyle = this.o.bgColor, c.arc(this.xy, this.xy, this.radius, this.endAngle - 1e-5, this.startAngle + 1e-5, !0), 
            c.stroke()), this.o.displayPrevious && (pa = this.arc(this.v), c.beginPath(), c.strokeStyle = this.pColor, 
            c.arc(this.xy, this.xy, this.radius, pa.s, pa.e, pa.d), c.stroke(), r = this.cv == this.v), 
            c.beginPath(), c.strokeStyle = r ? this.o.fgColor : this.fgColor, c.arc(this.xy, this.xy, this.radius, a.s, a.e, a.d), 
            c.stroke();
            ...
            return this.each(function() {
                ...
                if (me.parent().hasClass(o.wrapperClass)) {
                    ...
                    o.railDraggable && bar.bind("mousedown", function(e) {
                        ...
                        (e.originalEvent.preventDefault(), e.originalEvent.targetTouches.length) && (scrollContent((touchDif - e.originalEvent.targetTouches[0].pageY) / o.touchScrollStep, !0), 
                        ...
                        (releaseScroll || e.originalEvent.preventDefault(), e.originalEvent.touches.length) && (scrollContent((touchDif - e.originalEvent.touches[0].pageY) / o.touchScrollStep, !0), 
                    ...
                    o.alwaysVisible || bar.hide()), function() {
                ...
                function _onWheel(e) {
                    if (isOverPanel) {
                        var delta = 0;
                        (e = e || window.event).wheelDelta && (delta = -e.wheelDelta / 120), e.detail && (delta = e.detail / 3);
                ...
                function scrollContent(y, isWheel, isJump) {
                    ...
                    delta = Math.min(Math.max(delta, 0), maxTop), delta = 0 < y ? Math.ceil(delta) : Math.floor(delta), 
                    bar.css({
                        top: delta + "px"
                    })), delta = (percentScroll = parseInt(bar.css("top")) / (me.outerHeight() - bar.outerHeight())) * (me[0].scrollHeight - me.outerHeight()), 
                    isJump) {
                        var offsetTop = (delta = y) / me[0].scrollHeight * me.outerHeight();
                ...
                function showBar() {
                    ...
                    lastScroll = percentScroll, barHeight >= me.outerHeight() ? releaseScroll = !0 : (bar.stop(!0, !0).fadeIn("fast"), 
                    o.railVisible && rail.stop(!0, !0).fadeIn("fast"));
                }
                function hideBar() {
    ...
    function FastClick(layer, options) {
        ...
        this.tapTimeout = options.tapTimeout || 700, !FastClick.notNeeded(layer)) {
            for (var methods = [ "onMouse", "onClick", "onTouchStart", "onTouchMove", "onTouchEnd", "onTouchCancel" ], i = 0, l = methods.length; i < l; i++) this[methods[i]] = bind(this[methods[i]], this);
    ...
    FastClick.prototype.needsClick = function(target) {
        ...
        touch = event.changedTouches[0], (clickEvent = document.createEvent("MouseEvents")).initMouseEvent(this.determineEventType(targetElement), !0, !0, window, 1, touch.screenX, touch.screenY, touch.clientX, touch.clientY, !1, !1, !1, !1, 0, null), 
        ...
        (targetElement = document.elementFromPoint(touch.pageX - window.pageXOffset, touch.pageY - window.pageYOffset) || targetElement).fastClickScrollParent = this.targetElement.fastClickScrollParent), 
        ...
        } else if (this.needsFocus(targetElement)) return 100 < event.timeStamp - trackingClickStart || deviceIsIOS && window.top !== window && "input" === targetTagName ? this.targetElement = null : (this.focus(targetElement), 
        this.sendClick(targetElement, event), deviceIsIOS && "select" === targetTagName || (this.targetElement = null, 
        ...
        var permitted;
        return this.trackingClick ? (this.targetElement = null, !(this.trackingClick = !1)) : "submit" === event.target.type && 0 === event.detail || ((permitted = this.onMouse(event)) || (this.targetElement = null), 
        permitted);
        ...
        if (chromeVersion = +(/Chrome\/([0-9]+)/.exec(navigator.userAgent) || [ , 0 ])[1]) {
            ...
            if (metaViewport = document.querySelector("meta[name=viewport]")) {
                ...
                if (31 < chromeVersion && document.documentElement.scrollWidth <= window.outerWidth) return !0;
            }
        }
        if (deviceIsBlackBerry10 && 10 <= (blackberryVersion = navigator.userAgent.match(/Version\/([0-9]*)\.([0-9]*)/))[1] && 3 <= blackberryVersion[2] && (metaViewport = document.querySelector("meta[name=viewport]"))) {
            if (-1 !== metaViewport.content.indexOf("user-scalable=no")) return !0;
    ...
    "object" == typeof exports && "undefined" != typeof module ? factory(exports) : "function" == typeof define && define.amd ? define([ "exports" ], factory) : factory(global.adminlte = {});
    ...
    var _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(obj) {
        ...
        var NAME = "ControlSidebar", JQUERY_NO_CONFLICT = $.fn[NAME], Selector_CONTROL_SIDEBAR = ".control-sidebar", Selector_DATA_TOGGLE = '[data-widget="control-sidebar"]', Selector_MAIN_HEADER = ".main-header", ClassName_CONTROL_SIDEBAR_OPEN = "control-sidebar-open", ClassName_CONTROL_SIDEBAR_SLIDE = "control-sidebar-slide-open", Default = {
            slide: !0
        }, ControlSidebar = function() {
            function ControlSidebar(element, config) {
                classCallCheck(this, ControlSidebar), this._element = element, this._config = this._getConfig(config);
            }
            return ControlSidebar.prototype.show = function() {
                this._config.slide ? $("body").removeClass(ClassName_CONTROL_SIDEBAR_SLIDE) : $("body").removeClass(ClassName_CONTROL_SIDEBAR_OPEN);
            }, ControlSidebar.prototype.collapse = function() {
                this._config.slide ? $("body").addClass(ClassName_CONTROL_SIDEBAR_SLIDE) : $("body").addClass(ClassName_CONTROL_SIDEBAR_OPEN);
            }, ControlSidebar.prototype.toggle = function() {
                this._setMargin(), $("body").hasClass(ClassName_CONTROL_SIDEBAR_OPEN) || $("body").hasClass(ClassName_CONTROL_SIDEBAR_SLIDE) ? this.show() : this.collapse();
            }, ControlSidebar.prototype._getConfig = function(config) {
                return $.extend({}, Default, config);
            }, ControlSidebar.prototype._setMargin = function() {
                $(Selector_CONTROL_SIDEBAR).css({
                    top: $(Selector_MAIN_HEADER).outerHeight()
                });
            }, ControlSidebar._jQueryInterface = function(operation) {
                return this.each(function() {
                    var data = $(this).data("lte.control.sidebar");
                    if (data || (data = new ControlSidebar(this, $(this).data()), $(this).data("lte.control.sidebar", data)), 
                    "undefined" === data[operation]) throw new Error(operation + " is not a function");
                    data[operation]();
                });
            }, ControlSidebar;
        }();
        return $(document).on("click", Selector_DATA_TOGGLE, function(event) {
            event.preventDefault(), ControlSidebar._jQueryInterface.call($(this), "toggle");
        }), $.fn[NAME] = ControlSidebar._jQueryInterface, $.fn[NAME].Constructor = ControlSidebar, 
        $.fn[NAME].noConflict = function() {
            return $.fn[NAME] = JQUERY_NO_CONFLICT, ControlSidebar._jQueryInterface;
        }, ControlSidebar;
    }(jQuery), Layout = function($) {
        var NAME = "Layout", JQUERY_NO_CONFLICT = $.fn[NAME], Selector_SIDEBAR = ".main-sidebar", Selector_HEADER = ".main-header", Selector_CONTENT = ".content-wrapper", Selector_FOOTER = ".main-footer", ClassName_HOLD = "hold-transition", Layout = function() {
            function Layout(element) {
                classCallCheck(this, Layout), this._element = element, this._init();
            }
            return Layout.prototype.fixLayoutHeight = function() {
                var heights = {
                    window: $(window).height(),
                    header: $(Selector_HEADER).outerHeight(),
                    footer: $(Selector_FOOTER).outerHeight(),
                    sidebar: $(Selector_SIDEBAR).height()
                }, max = this._max(heights);
                $(Selector_CONTENT).css("min-height", max - heights.header), $(Selector_SIDEBAR).css("min-height", max - heights.header);
            }, Layout.prototype._init = function() {
                var _this = this;
                $("body").removeClass(ClassName_HOLD), this.fixLayoutHeight(), $(Selector_SIDEBAR).on("collapsed.lte.treeview expanded.lte.treeview collapsed.lte.pushmenu expanded.lte.pushmenu", function() {
                ...
                var max = 0;
                return Object.keys(numbers).forEach(function(key) {
                    numbers[key] > max && (max = numbers[key]);
                }), max;
            }, Layout._jQueryInterface = function(operation) {
                return this.each(function() {
                    var data = $(this).data("lte.layout");
                    data || (data = new Layout(this), $(this).data("lte.layout", data)), operation && data[operation]();
                });
            }, Layout;
        }();
        return $(window).on("load", function() {
            Layout._jQueryInterface.call($("body"));
        }), $.fn[NAME] = Layout._jQueryInterface, $.fn[NAME].Constructor = Layout, $.fn[NAME].noConflict = function() {
            return $.fn[NAME] = JQUERY_NO_CONFLICT, Layout._jQueryInterface;
        }, Layout;
    }(jQuery), PushMenu = function($) {
        var NAME = "PushMenu", JQUERY_NO_CONFLICT = $.fn[NAME], Event = {
            COLLAPSED: "collapsed.lte.pushmenu",
            SHOWN: "shown.lte.pushmenu"
        }, Default = {
            screenCollapseSize: 768
        }, Selector_TOGGLE_BUTTON = '[data-widget="pushmenu"]', Selector_BODY = "body", Selector_OVERLAY = "#sidebar-overlay", Selector_WRAPPER = ".wrapper", ClassName_COLLAPSED = "sidebar-collapse", ClassName_OPEN = "sidebar-open", PushMenu = function() {
            function PushMenu(element, options) {
                classCallCheck(this, PushMenu), this._element = element, this._options = $.extend({}, Default, options), 
                $(Selector_OVERLAY).length || this._addOverlay();
            }
            return PushMenu.prototype.show = function() {
                $(Selector_BODY).addClass(ClassName_OPEN).removeClass(ClassName_COLLAPSED);
                var shownEvent = $.Event(Event.SHOWN);
                $(this._element).trigger(shownEvent);
            }, PushMenu.prototype.collapse = function() {
                $(Selector_BODY).removeClass(ClassName_OPEN).addClass(ClassName_COLLAPSED);
                var collapsedEvent = $.Event(Event.COLLAPSED);
                $(this._element).trigger(collapsedEvent);
            }, PushMenu.prototype.toggle = function() {
                ($(window).width() >= this._options.screenCollapseSize ? !$(Selector_BODY).hasClass(ClassName_COLLAPSED) : $(Selector_BODY).hasClass(ClassName_OPEN)) ? this.collapse() : this.show();
            }, PushMenu.prototype._addOverlay = function() {
                var _this = this, overlay = $("<div />", {
                    id: "sidebar-overlay"
                });
                ...
                return this.each(function() {
                    ...
                    data || (data = new PushMenu(this), $(this).data("lte.pushmenu", data)), operation && data[operation]();
                });
            }, PushMenu;
        }();
        return $(document).on("click", Selector_TOGGLE_BUTTON, function(event) {
            event.preventDefault();
            var button = event.currentTarget;
            "pushmenu" !== $(button).data("widget") && (button = $(button).closest(Selector_TOGGLE_BUTTON)), 
            PushMenu._jQueryInterface.call($(button), "toggle");
        }), $.fn[NAME] = PushMenu._jQueryInterface, $.fn[NAME].Constructor = PushMenu, $.fn[NAME].noConflict = function() {
            return $.fn[NAME] = JQUERY_NO_CONFLICT, PushMenu._jQueryInterface;
        }, PushMenu;
    }(jQuery), Treeview = function($) {
        var NAME = "Treeview", JQUERY_NO_CONFLICT = $.fn[NAME], Event = {
        ...
        }, Selector_LI = ".nav-item", Selector_TREEVIEW_MENU = ".nav-treeview", Selector_OPEN = ".menu-open", Selector_DATA_WIDGET = '[data-widget="treeview"]', ClassName_OPEN = "menu-open", Default = {
            trigger: Selector_DATA_WIDGET + " " + ".nav-link",
            animationSpeed: 300,
            accordion: !0
        }, Treeview = function() {
            function Treeview(element, config) {
                classCallCheck(this, Treeview), this._config = config, this._element = element;
            }
            return Treeview.prototype.init = function() {
                this._setupListeners();
            }, Treeview.prototype.expand = function(treeviewMenu, parentLi) {
                var _this = this, expandedEvent = $.Event(Event.EXPANDED);
                if (this._config.accordion) {
                    var openMenuLi = parentLi.siblings(Selector_OPEN).first(), openTreeview = openMenuLi.find(Selector_TREEVIEW_MENU).first();
                    this.collapse(openTreeview, openMenuLi);
                }
                treeviewMenu.slideDown(this._config.animationSpeed, function() {
                    parentLi.addClass(ClassName_OPEN), $(_this._element).trigger(expandedEvent);
                });
            }, Treeview.prototype.collapse = function(treeviewMenu, parentLi) {
                var _this2 = this, collapsedEvent = $.Event(Event.COLLAPSED);
                treeviewMenu.slideUp(this._config.animationSpeed, function() {
                    parentLi.removeClass(ClassName_OPEN), $(_this2._element).trigger(collapsedEvent), 
                    treeviewMenu.find(Selector_OPEN + " > " + Selector_TREEVIEW_MENU).slideUp(), treeviewMenu.find(Selector_OPEN).removeClass(ClassName_OPEN);
                });
                ...
                if (treeviewMenu.is(Selector_TREEVIEW_MENU)) {
                    ...
                    parentLi.hasClass(ClassName_OPEN) ? this.collapse($(treeviewMenu), parentLi) : this.expand($(treeviewMenu), parentLi);
                }
                ...
                return this.each(function() {
                    var data = $(this).data("lte.treeview"), _config = $.extend({}, Default, $(this).data());
                    data || (data = new Treeview($(this), _config), $(this).data("lte.treeview", data)), 
        ...
        }), $.fn[NAME] = Treeview._jQueryInterface, $.fn[NAME].Constructor = Treeview, $.fn[NAME].noConflict = function() {
            return $.fn[NAME] = JQUERY_NO_CONFLICT, Treeview._jQueryInterface;
        }, Treeview;
    }(jQuery), Widget = function($) {
        var NAME = "Widget", JQUERY_NO_CONFLICT = $.fn[NAME], Event = {
            EXPANDED: "expanded.lte.widget",
            COLLAPSED: "collapsed.lte.widget",
            REMOVED: "removed.lte.widget"
        }, Selector_DATA_REMOVE = '[data-widget="remove"]', Selector_DATA_COLLAPSE = '[data-widget="collapse"]', Selector_CARD = ".card", Selector_CARD_BODY = ".card-body", Selector_CARD_FOOTER = ".card-footer", ClassName_COLLAPSED = "collapsed-card", Default = {
            animationSpeed: "normal",
            collapseTrigger: Selector_DATA_COLLAPSE,
            removeTrigger: Selector_DATA_REMOVE
        }, Widget = function() {
            function Widget(element, settings) {
                classCallCheck(this, Widget), this._element = element, this._parent = element.parents(Selector_CARD).first(), 
                this._settings = $.extend({}, Default, settings);
            }
            return Widget.prototype.collapse = function() {
                var _this = this;
                this._parent.children(Selector_CARD_BODY + ", " + Selector_CARD_FOOTER).slideUp(this._settings.animationSpeed, function() {
                    _this._parent.addClass(ClassName_COLLAPSED);
                });
                var collapsed = $.Event(Event.COLLAPSED);
                this._element.trigger(collapsed, this._parent);
            }, Widget.prototype.expand = function() {
                var _this2 = this;
                this._parent.children(Selector_CARD_BODY + ", " + Selector_CARD_FOOTER).slideDown(this._settings.animationSpeed, function() {
                    _this2._parent.removeClass(ClassName_COLLAPSED);
                });
                ...
                this._parent.hasClass(ClassName_COLLAPSED) ? this.expand() : this.collapse();
            }, Widget.prototype._init = function(card) {
                var _this3 = this;
                this._parent = card, $(this).find(this._settings.collapseTrigger).click(function() {
                    _this3.toggle();
                }), $(this).find(this._settings.removeTrigger).click(function() {
                    _this3.remove();
                });
            }, Widget._jQueryInterface = function(config) {
                return this.each(function() {
                    var data = $(this).data("lte.widget");
                    data || (data = new Widget($(this), data), $(this).data("lte.widget", "string" == typeof config ? data : config)), 
                    "string" == typeof config && config.match(/remove|toggle/) ? data[config]() : "object" === (void 0 === config ? "undefined" : _typeof(config)) && data._init($(this));
                });
            }, Widget;
        }();
        return $(document).on("click", Selector_DATA_COLLAPSE, function(event) {
            event && event.preventDefault(), Widget._jQueryInterface.call($(this), "toggle");
        }), $(document).on("click", Selector_DATA_REMOVE, function(event) {
            event && event.preventDefault(), Widget._jQueryInterface.call($(this), "remove");
        }), $.fn[NAME] = Widget._jQueryInterface, $.fn[NAME].Constructor = Widget, $.fn[NAME].noConflict = function() {
            return $.fn[NAME] = JQUERY_NO_CONFLICT, Widget._jQueryInterface;
        }, Widget;
    }(jQuery);
    exports.ControlSidebar = ControlSidebar, exports.Layout = Layout, exports.PushMenu = PushMenu, 
    exports.Treeview = Treeview, exports.Widget = Widget, Object.defineProperty(exports, "__esModule", {
        value: !0
    });
});