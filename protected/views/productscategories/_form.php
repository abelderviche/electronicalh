			...
			<div class="col-md-12">
				<div class="card card-primary">
					<div class="card-header">
		            	<h3 class="card-title"><?=($model->isNewRecord?'Creando':'Editando');?> categoria</h3>
		            </div>
					...
					<div class="card-body">
						<div class="row">
							<div class="col-sm-12 col-md-6">
						        <div class="form-group">
									...
									<?php echo $form->textField($model,'name',array('size'=>45,'maxlength'=>45,'class'=>'form-control','disabled'=>($model->isNewRecord?'':'disabled'))); ?>
						...
						<div class="form-group" id="uploaded">
							...
							<br>
							 <?php echo CHtml::image(Yii::app()->request->baseUrl.'/images/productscategories/'.$model->id.'/'.$model->image,"image",array("class"=>"col-md-4")); ?>  
				        ...
				        <div class="form-group <?=($model->image!='' && $model->image!='value'?'hidden':'');?>" id="uploaderImage">
				        	...
				        	<?php 
							    ...
							    'model' => $model,
							    'attribute' => 'image',
							    'url' => $this->createUrl('productscategories/insert'),
