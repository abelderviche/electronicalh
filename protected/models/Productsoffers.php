...
/**
 * This is the model class for table "products_offers".
 *
 * The followings are the available columns in table 'products_offers':
 * @property integer $id
...
class Productsoffers extends CActiveRecord
{
	 ...
	 * @return Productsoffers the static model class
	 */
